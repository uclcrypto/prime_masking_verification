...
module SQ_2SHARE_PROLEADWRAP ( clk, a0, a1, r0, r1, b0, b1 );
  ...
  output [2:0] b1;
  input clk;
  wire   SQ_instance_n216, SQ_instance_n215, SQ_instance_n214,
  ...
  XOR2_X1 SQ_instance_U223 ( .A(SQ_instance_n208), .B(SQ_instance_n207), .Z(
        SQ_instance_n213) );
  XNOR2_X1 SQ_instance_U222 ( .A(r0[1]), .B(a1[0]), .ZN(SQ_instance_n207) );
  ...
  NAND2_X1 SQ_instance_U219 ( .A1(SQ_instance_n211), .A2(SQ_instance_n210), 
        .ZN(SQ_instance_n205) );
  XNOR2_X1 SQ_instance_U218 ( .A(r0[2]), .B(SQ_instance_n204), .ZN(
        SQ_instance_n211) );
  NAND2_X1 SQ_instance_U217 ( .A1(r0[2]), .A2(a1[1]), .ZN(SQ_instance_n206) );
  XNOR2_X1 SQ_instance_U216 ( .A(r0[0]), .B(SQ_instance_n203), .ZN(
        SQ_instance_n216) );
  ...
  NOR2_X1 SQ_instance_U212 ( .A1(SQ_instance_n197), .A2(SQ_instance_n203), 
        .ZN(SQ_instance_n208) );
  NAND2_X1 SQ_instance_U211 ( .A1(r0[1]), .A2(a1[0]), .ZN(SQ_instance_n202) );
  ...
  NAND2_X1 SQ_instance_U195 ( .A1(SQ_instance_n184), .A2(SQ_instance_n183), 
        .ZN(SQ_instance_n188) );
  XOR2_X1 SQ_instance_U194 ( .A(r1[0]), .B(SQ_instance_n177), .Z(
        SQ_instance_n183) );
  ...
  NOR2_X1 SQ_instance_U185 ( .A1(SQ_instance_n168), .A2(SQ_instance_n167), 
        .ZN(SQ_instance_n163) );
  NAND2_X1 SQ_instance_U184 ( .A1(SQ_instance_n162), .A2(a0[2]), .ZN(
        SQ_instance_n167) );
  ...
  AND2_X1 SQ_instance_U164 ( .A1(SQ_instance_n147), .A2(SQ_instance_n149), 
        .ZN(SQ_instance_n136) );
  NAND2_X1 SQ_instance_U163 ( .A1(a0[2]), .A2(SQ_instance_n135), .ZN(
        SQ_instance_n149) );
  NAND2_X1 SQ_instance_U162 ( .A1(SQ_instance_n134), .A2(r1[2]), .ZN(
        SQ_instance_n147) );
  NAND2_X1 SQ_instance_U161 ( .A1(a0[1]), .A2(SQ_instance_n160), .ZN(
        SQ_instance_n146) );
  ...
  AND2_X1 SQ_instance_U154 ( .A1(SQ_instance_n169), .A2(SQ_instance_n172), 
        .ZN(SQ_instance_n130) );
  NAND2_X1 SQ_instance_U153 ( .A1(a0[0]), .A2(SQ_instance_n135), .ZN(
        SQ_instance_n172) );
  NAND2_X1 SQ_instance_U152 ( .A1(SQ_instance_n177), .A2(r1[0]), .ZN(
        SQ_instance_n169) );
  AND2_X1 SQ_instance_U151 ( .A1(a0[0]), .A2(SQ_instance_n129), .ZN(
        SQ_instance_n177) );
  XNOR2_X1 SQ_instance_U150 ( .A(SQ_instance_n128), .B(SQ_instance_n127), .ZN(
        SQ_instance_n170) );
  XOR2_X1 SQ_instance_U149 ( .A(r1[2]), .B(SQ_instance_n134), .Z(
        SQ_instance_n140) );
  AND2_X1 SQ_instance_U148 ( .A1(a0[2]), .A2(SQ_instance_n129), .ZN(
        SQ_instance_n134) );
  ...
  XNOR2_X1 SQ_instance_U146 ( .A(SQ_instance_n150), .B(SQ_instance_n153), .ZN(
        SQ_instance_n126) );
  AND2_X1 SQ_instance_U145 ( .A1(a0[0]), .A2(SQ_instance_n160), .ZN(
        SQ_instance_n153) );
  ...
  NOR2_X1 SQ_instance_U141 ( .A1(SQ_instance_n127), .A2(SQ_instance_n128), 
        .ZN(SQ_instance_n150) );
  NAND2_X1 SQ_instance_U140 ( .A1(a0[1]), .A2(SQ_instance_n129), .ZN(
        SQ_instance_n127) );
  XOR2_X1 SQ_instance_U139 ( .A(SQ_instance_n119), .B(SQ_instance_n118), .Z(
        SQ_instance_n129) );
  AND2_X1 SQ_instance_U138 ( .A1(a0[1]), .A2(SQ_instance_n135), .ZN(
        SQ_instance_n151) );
  ...
  XOR2_X1 SQ_instance_U136 ( .A(SQ_instance_n117), .B(SQ_instance_n116), .Z(
        SQ_instance_n121) );
  XNOR2_X1 SQ_instance_U135 ( .A(a0[1]), .B(r0[1]), .ZN(SQ_instance_n116) );
  ...
  AND2_X1 SQ_instance_U132 ( .A1(SQ_instance_n122), .A2(SQ_instance_n124), 
        .ZN(SQ_instance_n114) );
  XNOR2_X1 SQ_instance_U131 ( .A(r0[2]), .B(a0[2]), .ZN(SQ_instance_n124) );
  ...
  NAND2_X1 SQ_instance_U129 ( .A1(SQ_instance_n117), .A2(SQ_instance_n111), 
        .ZN(SQ_instance_n112) );
  NAND2_X1 SQ_instance_U128 ( .A1(SQ_instance_n198), .A2(a0[1]), .ZN(
        SQ_instance_n111) );
  NAND2_X1 SQ_instance_U127 ( .A1(a0[0]), .A2(SQ_instance_n197), .ZN(
        SQ_instance_n117) );
  INV_X1 SQ_instance_U126 ( .A(r0[0]), .ZN(SQ_instance_n197) );
  OR2_X1 SQ_instance_U125 ( .A1(SQ_instance_n198), .A2(a0[1]), .ZN(
        SQ_instance_n113) );
  INV_X1 SQ_instance_U124 ( .A(r0[1]), .ZN(SQ_instance_n198) );
  NOR2_X1 SQ_instance_U123 ( .A1(r0[2]), .A2(SQ_instance_n161), .ZN(
        SQ_instance_n115) );
  INV_X1 SQ_instance_U122 ( .A(a0[2]), .ZN(SQ_instance_n161) );
  XNOR2_X1 SQ_instance_U121 ( .A(r0[0]), .B(a0[0]), .ZN(SQ_instance_n118) );
  ...
  NOR2_X1 SQ_instance_U35 ( .A1(SQ_instance_n24), .A2(SQ_instance_n203), .ZN(
        SQ_instance_n26) );
  INV_X1 SQ_instance_U34 ( .A(a1[2]), .ZN(SQ_instance_n203) );
  NOR2_X1 SQ_instance_U33 ( .A1(a1[1]), .A2(SQ_instance_n23), .ZN(
        SQ_instance_n24) );
  ...
  XOR2_X1 SQ_instance_U26 ( .A(SQ_instance_n14), .B(SQ_instance_n13), .Z(
        SQ_instance_n29) );
  NAND2_X1 SQ_instance_U25 ( .A1(SQ_instance_n204), .A2(a1[2]), .ZN(
        SQ_instance_n13) );
  ...
  OR2_X1 SQ_instance_U19 ( .A1(SQ_instance_n30), .A2(SQ_instance_n32), .ZN(
        SQ_instance_n17) );
  XOR2_X1 SQ_instance_U18 ( .A(r1[1]), .B(SQ_instance_n6), .Z(SQ_instance_n32)
         );
  OR2_X1 SQ_instance_U17 ( .A1(SQ_instance_n19), .A2(SQ_instance_n18), .ZN(
        SQ_instance_n30) );
  XNOR2_X1 SQ_instance_U16 ( .A(r1[0]), .B(SQ_instance_n199), .ZN(
        SQ_instance_n18) );
  ...
  XOR2_X1 SQ_instance_U14 ( .A(SQ_instance_n22), .B(SQ_instance_n9), .Z(
        SQ_instance_n5) );
  NOR2_X1 SQ_instance_U13 ( .A1(r1[2]), .A2(SQ_instance_n204), .ZN(
        SQ_instance_n9) );
  INV_X1 SQ_instance_U12 ( .A(a1[1]), .ZN(SQ_instance_n204) );
  ...
  NOR2_X1 SQ_instance_U10 ( .A1(SQ_instance_n199), .A2(SQ_instance_n2), .ZN(
        SQ_instance_n3) );
  NAND2_X1 SQ_instance_U9 ( .A1(r1[2]), .A2(a1[1]), .ZN(SQ_instance_n2) );
  ...
  AND2_X1 SQ_instance_U7 ( .A1(SQ_instance_n6), .A2(SQ_instance_n128), .ZN(
        SQ_instance_n21) );
  INV_X1 SQ_instance_U6 ( .A(r1[1]), .ZN(SQ_instance_n128) );
  NOR2_X1 SQ_instance_U5 ( .A1(r1[0]), .A2(SQ_instance_n199), .ZN(
        SQ_instance_n6) );
  XOR2_X1 SQ_instance_U4 ( .A(r1[2]), .B(SQ_instance_n1), .Z(SQ_instance_n20)
         );
  NAND2_X1 SQ_instance_U3 ( .A1(SQ_instance_n199), .A2(a1[1]), .ZN(
        SQ_instance_n1) );
  INV_X1 SQ_instance_U2 ( .A(a1[0]), .ZN(SQ_instance_n199) );
  NAND2_X1 SQ_instance_U1 ( .A1(a1[0]), .A2(a1[2]), .ZN(SQ_instance_n7) );
