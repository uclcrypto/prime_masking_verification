...
(* SILVER="clock" *)  input clk;
  wire   N3, N5, r0_p_r, r1_p_r, n6, n7, n8, n9, n10, RED1_n2, RED1_n1,
         RED2_n2, RED2_n1, SQ_instance_n216, SQ_instance_n215,
  ...
  NOR2_X1 U16 ( .A1(r0_p_r), .A2(r1_p_r), .ZN(n6) );
  AND2_X1 U17 ( .A1(n6), .A2(a0_mod_r[2]), .ZN(a0_sel_r[2]) );
  AND2_X1 U18 ( .A1(n6), .A2(a0_mod_r[0]), .ZN(a0_sel_r[0]) );
  AND2_X1 U19 ( .A1(n6), .A2(a1_mod_r[2]), .ZN(a1_sel_r[2]) );
  AND2_X1 U20 ( .A1(n6), .A2(a1_mod_r[1]), .ZN(a1_sel_r[1]) );
  AND2_X1 U21 ( .A1(n6), .A2(a0_mod_r[1]), .ZN(a0_sel_r[1]) );
  AND2_X1 U22 ( .A1(n6), .A2(a1_mod_r[0]), .ZN(a1_sel_r[0]) );
  INV_X1 U23 ( .A(r0[2]), .ZN(n8) );
  NAND2_X1 U24 ( .A1(r0[0]), .A2(r0[1]), .ZN(n7) );
  NOR2_X1 U25 ( .A1(n8), .A2(n7), .ZN(N3) );
  INV_X1 U26 ( .A(r1[2]), .ZN(n10) );
  NAND2_X1 U27 ( .A1(r1[0]), .A2(r1[1]), .ZN(n9) );
  NOR2_X1 U28 ( .A1(n10), .A2(n9), .ZN(N5) );
  ...
  XOR2_X1 SQ_instance_U228 ( .A(SQ_instance_n216), .B(SQ_instance_n215), .Z(
        SQ_instance_a12r0[0]) );
  XOR2_X1 SQ_instance_U227 ( .A(SQ_instance_n214), .B(SQ_instance_n213), .Z(
        SQ_instance_a12r0[1]) );
  XNOR2_X1 SQ_instance_U226 ( .A(SQ_instance_n212), .B(SQ_instance_n211), .ZN(
        SQ_instance_a12r0[2]) );
  NOR2_X1 SQ_instance_U225 ( .A1(SQ_instance_n210), .A2(SQ_instance_n209), 
        .ZN(SQ_instance_n212) );
  NOR2_X1 SQ_instance_U224 ( .A1(SQ_instance_n214), .A2(SQ_instance_n213), 
        .ZN(SQ_instance_n209) );
  XOR2_X1 SQ_instance_U223 ( .A(SQ_instance_n208), .B(SQ_instance_n207), .Z(
        SQ_instance_n213) );
  XNOR2_X1 SQ_instance_U222 ( .A(r0_rr[1]), .B(a1_sel_rr[0]), .ZN(
        SQ_instance_n207) );
  NAND2_X1 SQ_instance_U221 ( .A1(SQ_instance_n216), .A2(SQ_instance_n215), 
        .ZN(SQ_instance_n214) );
  NAND2_X1 SQ_instance_U220 ( .A1(SQ_instance_n206), .A2(SQ_instance_n205), 
        .ZN(SQ_instance_n215) );
  NAND2_X1 SQ_instance_U219 ( .A1(SQ_instance_n211), .A2(SQ_instance_n210), 
        .ZN(SQ_instance_n205) );
  XNOR2_X1 SQ_instance_U218 ( .A(r0_rr[2]), .B(SQ_instance_n204), .ZN(
        SQ_instance_n211) );
  NAND2_X1 SQ_instance_U217 ( .A1(r0_rr[2]), .A2(a1_sel_rr[1]), .ZN(
        SQ_instance_n206) );
  XNOR2_X1 SQ_instance_U216 ( .A(r0_rr[0]), .B(SQ_instance_n203), .ZN(
        SQ_instance_n216) );
  NAND2_X1 SQ_instance_U215 ( .A1(SQ_instance_n202), .A2(SQ_instance_n201), 
        .ZN(SQ_instance_n210) );
  NAND2_X1 SQ_instance_U214 ( .A1(SQ_instance_n208), .A2(SQ_instance_n200), 
        .ZN(SQ_instance_n201) );
  NAND2_X1 SQ_instance_U213 ( .A1(SQ_instance_n199), .A2(SQ_instance_n198), 
        .ZN(SQ_instance_n200) );
  NOR2_X1 SQ_instance_U212 ( .A1(SQ_instance_n197), .A2(SQ_instance_n203), 
        .ZN(SQ_instance_n208) );
  NAND2_X1 SQ_instance_U211 ( .A1(r0_rr[1]), .A2(a1_sel_rr[0]), .ZN(
        SQ_instance_n202) );
  XOR2_X1 SQ_instance_U210 ( .A(SQ_instance_n196), .B(SQ_instance_n195), .Z(
        SQ_instance_a0r0a0r1[0]) );
  XOR2_X1 SQ_instance_U209 ( .A(SQ_instance_n194), .B(SQ_instance_n193), .Z(
        SQ_instance_a0r0a0r1[1]) );
  XNOR2_X1 SQ_instance_U208 ( .A(SQ_instance_n192), .B(SQ_instance_n191), .ZN(
        SQ_instance_a0r0a0r1[2]) );
  NAND2_X1 SQ_instance_U207 ( .A1(SQ_instance_n190), .A2(SQ_instance_n189), 
        .ZN(SQ_instance_n191) );
  NAND2_X1 SQ_instance_U206 ( .A1(SQ_instance_n194), .A2(SQ_instance_n193), 
        .ZN(SQ_instance_n190) );
  XOR2_X1 SQ_instance_U205 ( .A(SQ_instance_n188), .B(SQ_instance_n187), .Z(
        SQ_instance_n193) );
  XNOR2_X1 SQ_instance_U204 ( .A(SQ_instance_n186), .B(SQ_instance_n185), .ZN(
        SQ_instance_n187) );
  NOR2_X1 SQ_instance_U203 ( .A1(SQ_instance_n196), .A2(SQ_instance_n195), 
        .ZN(SQ_instance_n194) );
  XNOR2_X1 SQ_instance_U202 ( .A(SQ_instance_n184), .B(SQ_instance_n183), .ZN(
        SQ_instance_n195) );
  NOR2_X1 SQ_instance_U201 ( .A1(SQ_instance_n182), .A2(SQ_instance_n181), 
        .ZN(SQ_instance_n196) );
  NOR2_X1 SQ_instance_U200 ( .A1(SQ_instance_n189), .A2(SQ_instance_n192), 
        .ZN(SQ_instance_n181) );
  NOR2_X1 SQ_instance_U199 ( .A1(SQ_instance_n180), .A2(SQ_instance_n179), 
        .ZN(SQ_instance_n189) );
  NOR2_X1 SQ_instance_U198 ( .A1(SQ_instance_n186), .A2(SQ_instance_n188), 
        .ZN(SQ_instance_n179) );
  NOR2_X1 SQ_instance_U197 ( .A1(SQ_instance_n185), .A2(SQ_instance_n178), 
        .ZN(SQ_instance_n180) );
  AND2_X1 SQ_instance_U196 ( .A1(SQ_instance_n186), .A2(SQ_instance_n188), 
        .ZN(SQ_instance_n178) );
  NAND2_X1 SQ_instance_U195 ( .A1(SQ_instance_n184), .A2(SQ_instance_n183), 
        .ZN(SQ_instance_n188) );
  XOR2_X1 SQ_instance_U194 ( .A(r1_rr[0]), .B(SQ_instance_n177), .Z(
        SQ_instance_n183) );
  XNOR2_X1 SQ_instance_U193 ( .A(SQ_instance_n176), .B(SQ_instance_n175), .ZN(
        SQ_instance_n184) );
  XOR2_X1 SQ_instance_U192 ( .A(SQ_instance_n174), .B(SQ_instance_n173), .Z(
        SQ_instance_n175) );
  XOR2_X1 SQ_instance_U191 ( .A(SQ_instance_n172), .B(SQ_instance_n171), .Z(
        SQ_instance_n186) );
  XOR2_X1 SQ_instance_U190 ( .A(SQ_instance_n170), .B(SQ_instance_n169), .Z(
        SQ_instance_n171) );
  XNOR2_X1 SQ_instance_U189 ( .A(SQ_instance_n168), .B(SQ_instance_n167), .ZN(
        SQ_instance_n185) );
  NOR2_X1 SQ_instance_U188 ( .A1(SQ_instance_n166), .A2(SQ_instance_n165), 
        .ZN(SQ_instance_n182) );
  ...
  NOR2_X1 SQ_instance_U186 ( .A1(SQ_instance_n164), .A2(SQ_instance_n163), 
        .ZN(SQ_instance_n165) );
  NOR2_X1 SQ_instance_U185 ( .A1(SQ_instance_n168), .A2(SQ_instance_n167), 
        .ZN(SQ_instance_n163) );
  NAND2_X1 SQ_instance_U184 ( .A1(SQ_instance_n162), .A2(a0_sel_rr[2]), .ZN(
        SQ_instance_n167) );
  XNOR2_X1 SQ_instance_U183 ( .A(SQ_instance_n160), .B(SQ_instance_n159), .ZN(
        SQ_instance_n162) );
  NOR2_X1 SQ_instance_U182 ( .A1(SQ_instance_n158), .A2(SQ_instance_n157), 
        .ZN(SQ_instance_n168) );
  AND2_X1 SQ_instance_U181 ( .A1(SQ_instance_n173), .A2(SQ_instance_n174), 
        .ZN(SQ_instance_n157) );
  NOR2_X1 SQ_instance_U180 ( .A1(SQ_instance_n176), .A2(SQ_instance_n156), 
        .ZN(SQ_instance_n158) );
  NOR2_X1 SQ_instance_U179 ( .A1(SQ_instance_n174), .A2(SQ_instance_n173), 
        .ZN(SQ_instance_n156) );
  NAND2_X1 SQ_instance_U178 ( .A1(SQ_instance_n155), .A2(SQ_instance_n154), 
        .ZN(SQ_instance_n173) );
  NAND2_X1 SQ_instance_U177 ( .A1(SQ_instance_n153), .A2(SQ_instance_n152), 
        .ZN(SQ_instance_n154) );
  OR2_X1 SQ_instance_U176 ( .A1(SQ_instance_n151), .A2(SQ_instance_n150), .ZN(
        SQ_instance_n152) );
  NAND2_X1 SQ_instance_U175 ( .A1(SQ_instance_n150), .A2(SQ_instance_n151), 
        .ZN(SQ_instance_n155) );
  XNOR2_X1 SQ_instance_U174 ( .A(SQ_instance_n149), .B(SQ_instance_n148), .ZN(
        SQ_instance_n174) );
  XOR2_X1 SQ_instance_U173 ( .A(SQ_instance_n147), .B(SQ_instance_n146), .Z(
        SQ_instance_n148) );
  NOR2_X1 SQ_instance_U172 ( .A1(SQ_instance_n145), .A2(SQ_instance_n144), 
        .ZN(SQ_instance_n176) );
  NOR2_X1 SQ_instance_U171 ( .A1(SQ_instance_n143), .A2(SQ_instance_n142), 
        .ZN(SQ_instance_n144) );
  NOR2_X1 SQ_instance_U170 ( .A1(SQ_instance_n141), .A2(SQ_instance_n140), 
        .ZN(SQ_instance_n142) );
  AND2_X1 SQ_instance_U169 ( .A1(SQ_instance_n141), .A2(SQ_instance_n140), 
        .ZN(SQ_instance_n145) );
  NOR2_X1 SQ_instance_U168 ( .A1(SQ_instance_n139), .A2(SQ_instance_n159), 
        .ZN(SQ_instance_n164) );
  NOR2_X1 SQ_instance_U167 ( .A1(SQ_instance_n138), .A2(SQ_instance_n137), 
        .ZN(SQ_instance_n159) );
  NOR2_X1 SQ_instance_U166 ( .A1(SQ_instance_n147), .A2(SQ_instance_n149), 
        .ZN(SQ_instance_n137) );
  NOR2_X1 SQ_instance_U165 ( .A1(SQ_instance_n146), .A2(SQ_instance_n136), 
        .ZN(SQ_instance_n138) );
  AND2_X1 SQ_instance_U164 ( .A1(SQ_instance_n147), .A2(SQ_instance_n149), 
        .ZN(SQ_instance_n136) );
  NAND2_X1 SQ_instance_U163 ( .A1(a0_sel_rr[2]), .A2(SQ_instance_n135), .ZN(
        SQ_instance_n149) );
  NAND2_X1 SQ_instance_U162 ( .A1(SQ_instance_n134), .A2(r1_rr[2]), .ZN(
        SQ_instance_n147) );
  NAND2_X1 SQ_instance_U161 ( .A1(a0_sel_rr[1]), .A2(SQ_instance_n160), .ZN(
        SQ_instance_n146) );
  INV_X1 SQ_instance_U160 ( .A(SQ_instance_n160), .ZN(SQ_instance_n139) );
  XOR2_X1 SQ_instance_U159 ( .A(SQ_instance_n141), .B(SQ_instance_n133), .Z(
        SQ_instance_n166) );
  XOR2_X1 SQ_instance_U158 ( .A(SQ_instance_n140), .B(SQ_instance_n143), .Z(
        SQ_instance_n133) );
  NOR2_X1 SQ_instance_U157 ( .A1(SQ_instance_n132), .A2(SQ_instance_n131), 
        .ZN(SQ_instance_n143) );
  NOR2_X1 SQ_instance_U156 ( .A1(SQ_instance_n169), .A2(SQ_instance_n172), 
        .ZN(SQ_instance_n131) );
  NOR2_X1 SQ_instance_U155 ( .A1(SQ_instance_n170), .A2(SQ_instance_n130), 
        .ZN(SQ_instance_n132) );
  AND2_X1 SQ_instance_U154 ( .A1(SQ_instance_n169), .A2(SQ_instance_n172), 
        .ZN(SQ_instance_n130) );
  NAND2_X1 SQ_instance_U153 ( .A1(a0_sel_rr[0]), .A2(SQ_instance_n135), .ZN(
        SQ_instance_n172) );
  NAND2_X1 SQ_instance_U152 ( .A1(SQ_instance_n177), .A2(r1_rr[0]), .ZN(
        SQ_instance_n169) );
  AND2_X1 SQ_instance_U151 ( .A1(a0_sel_rr[0]), .A2(SQ_instance_n129), .ZN(
        SQ_instance_n177) );
  XNOR2_X1 SQ_instance_U150 ( .A(SQ_instance_n128), .B(SQ_instance_n127), .ZN(
        SQ_instance_n170) );
  XOR2_X1 SQ_instance_U149 ( .A(r1_rr[2]), .B(SQ_instance_n134), .Z(
        SQ_instance_n140) );
  AND2_X1 SQ_instance_U148 ( .A1(a0_sel_rr[2]), .A2(SQ_instance_n129), .ZN(
        SQ_instance_n134) );
  XNOR2_X1 SQ_instance_U147 ( .A(SQ_instance_n151), .B(SQ_instance_n126), .ZN(
        SQ_instance_n141) );
  XNOR2_X1 SQ_instance_U146 ( .A(SQ_instance_n150), .B(SQ_instance_n153), .ZN(
        SQ_instance_n126) );
  AND2_X1 SQ_instance_U145 ( .A1(a0_sel_rr[0]), .A2(SQ_instance_n160), .ZN(
        SQ_instance_n153) );
  XNOR2_X1 SQ_instance_U144 ( .A(SQ_instance_n125), .B(SQ_instance_n124), .ZN(
        SQ_instance_n160) );
  NOR2_X1 SQ_instance_U143 ( .A1(SQ_instance_n123), .A2(SQ_instance_n122), 
        .ZN(SQ_instance_n125) );
  NOR2_X1 SQ_instance_U142 ( .A1(SQ_instance_n121), .A2(SQ_instance_n120), 
        .ZN(SQ_instance_n123) );
  NOR2_X1 SQ_instance_U141 ( .A1(SQ_instance_n127), .A2(SQ_instance_n128), 
        .ZN(SQ_instance_n150) );
  NAND2_X1 SQ_instance_U140 ( .A1(a0_sel_rr[1]), .A2(SQ_instance_n129), .ZN(
        SQ_instance_n127) );
  XOR2_X1 SQ_instance_U139 ( .A(SQ_instance_n119), .B(SQ_instance_n118), .Z(
        SQ_instance_n129) );
  AND2_X1 SQ_instance_U138 ( .A1(a0_sel_rr[1]), .A2(SQ_instance_n135), .ZN(
        SQ_instance_n151) );
  XOR2_X1 SQ_instance_U137 ( .A(SQ_instance_n120), .B(SQ_instance_n121), .Z(
        SQ_instance_n135) );
  XOR2_X1 SQ_instance_U136 ( .A(SQ_instance_n117), .B(SQ_instance_n116), .Z(
        SQ_instance_n121) );
  XNOR2_X1 SQ_instance_U135 ( .A(a0_sel_rr[1]), .B(r0_rr[1]), .ZN(
        SQ_instance_n116) );
  NAND2_X1 SQ_instance_U134 ( .A1(SQ_instance_n118), .A2(SQ_instance_n119), 
        .ZN(SQ_instance_n120) );
  OR2_X1 SQ_instance_U133 ( .A1(SQ_instance_n115), .A2(SQ_instance_n114), .ZN(
        SQ_instance_n119) );
  AND2_X1 SQ_instance_U132 ( .A1(SQ_instance_n122), .A2(SQ_instance_n124), 
        .ZN(SQ_instance_n114) );
  XNOR2_X1 SQ_instance_U131 ( .A(r0_rr[2]), .B(a0_sel_rr[2]), .ZN(
        SQ_instance_n124) );
  ...
  NAND2_X1 SQ_instance_U129 ( .A1(SQ_instance_n117), .A2(SQ_instance_n111), 
        .ZN(SQ_instance_n112) );
  NAND2_X1 SQ_instance_U128 ( .A1(SQ_instance_n198), .A2(a0_sel_rr[1]), .ZN(
        SQ_instance_n111) );
  NAND2_X1 SQ_instance_U127 ( .A1(a0_sel_rr[0]), .A2(SQ_instance_n197), .ZN(
        SQ_instance_n117) );
  INV_X1 SQ_instance_U126 ( .A(r0_rr[0]), .ZN(SQ_instance_n197) );
  OR2_X1 SQ_instance_U125 ( .A1(SQ_instance_n198), .A2(a0_sel_rr[1]), .ZN(
        SQ_instance_n113) );
  INV_X1 SQ_instance_U124 ( .A(r0_rr[1]), .ZN(SQ_instance_n198) );
  NOR2_X1 SQ_instance_U123 ( .A1(r0_rr[2]), .A2(SQ_instance_n161), .ZN(
        SQ_instance_n115) );
  INV_X1 SQ_instance_U122 ( .A(a0_sel_rr[2]), .ZN(SQ_instance_n161) );
  XNOR2_X1 SQ_instance_U121 ( .A(r0_rr[0]), .B(a0_sel_rr[0]), .ZN(
        SQ_instance_n118) );
  ...
  NAND2_X1 SQ_instance_U36 ( .A1(SQ_instance_n25), .A2(SQ_instance_n26), .ZN(
        SQ_instance_n28) );
  NOR2_X1 SQ_instance_U35 ( .A1(SQ_instance_n24), .A2(SQ_instance_n203), .ZN(
        SQ_instance_n26) );
  INV_X1 SQ_instance_U34 ( .A(a1_sel_rr[2]), .ZN(SQ_instance_n203) );
  NOR2_X1 SQ_instance_U33 ( .A1(a1_sel_rr[1]), .A2(SQ_instance_n23), .ZN(
        SQ_instance_n24) );
  ...
  XOR2_X1 SQ_instance_U26 ( .A(SQ_instance_n14), .B(SQ_instance_n13), .Z(
        SQ_instance_n29) );
  NAND2_X1 SQ_instance_U25 ( .A1(SQ_instance_n204), .A2(a1_sel_rr[2]), .ZN(
        SQ_instance_n13) );
  ...
  OR2_X1 SQ_instance_U19 ( .A1(SQ_instance_n30), .A2(SQ_instance_n32), .ZN(
        SQ_instance_n17) );
  XOR2_X1 SQ_instance_U18 ( .A(r1_rr[1]), .B(SQ_instance_n6), .Z(
        SQ_instance_n32) );
  OR2_X1 SQ_instance_U17 ( .A1(SQ_instance_n19), .A2(SQ_instance_n18), .ZN(
        SQ_instance_n30) );
  XNOR2_X1 SQ_instance_U16 ( .A(r1_rr[0]), .B(SQ_instance_n199), .ZN(
        SQ_instance_n18) );
  ...
  XOR2_X1 SQ_instance_U14 ( .A(SQ_instance_n22), .B(SQ_instance_n9), .Z(
        SQ_instance_n5) );
  NOR2_X1 SQ_instance_U13 ( .A1(r1_rr[2]), .A2(SQ_instance_n204), .ZN(
        SQ_instance_n9) );
  INV_X1 SQ_instance_U12 ( .A(a1_sel_rr[1]), .ZN(SQ_instance_n204) );
  NOR2_X1 SQ_instance_U11 ( .A1(SQ_instance_n4), .A2(SQ_instance_n3), .ZN(
        SQ_instance_n22) );
  NOR2_X1 SQ_instance_U10 ( .A1(SQ_instance_n199), .A2(SQ_instance_n2), .ZN(
        SQ_instance_n3) );
  NAND2_X1 SQ_instance_U9 ( .A1(r1_rr[2]), .A2(a1_sel_rr[1]), .ZN(
        SQ_instance_n2) );
  ...
  AND2_X1 SQ_instance_U7 ( .A1(SQ_instance_n6), .A2(SQ_instance_n128), .ZN(
        SQ_instance_n21) );
  INV_X1 SQ_instance_U6 ( .A(r1_rr[1]), .ZN(SQ_instance_n128) );
  NOR2_X1 SQ_instance_U5 ( .A1(r1_rr[0]), .A2(SQ_instance_n199), .ZN(
        SQ_instance_n6) );
  XOR2_X1 SQ_instance_U4 ( .A(r1_rr[2]), .B(SQ_instance_n1), .Z(
        SQ_instance_n20) );
  NAND2_X1 SQ_instance_U3 ( .A1(SQ_instance_n199), .A2(a1_sel_rr[1]), .ZN(
        SQ_instance_n1) );
  INV_X1 SQ_instance_U2 ( .A(a1_sel_rr[0]), .ZN(SQ_instance_n199) );
  NAND2_X1 SQ_instance_U1 ( .A1(a1_sel_rr[0]), .A2(a1_sel_rr[2]), .ZN(
        SQ_instance_n7) );
