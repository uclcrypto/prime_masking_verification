...
module SQ_2SHARE_PROLEADWRAP ( clk, a0, a1, r0, r1, b0, b1 );
  ...
  output [4:0] b1;
  input clk;
  wire   SQ_instance_n557, SQ_instance_n556, SQ_instance_n555,
  ...
  XOR2_X1 SQ_instance_U537 ( .A(SQ_instance_n503), .B(SQ_instance_n502), .Z(
        SQ_instance_n505) );
  NAND2_X1 SQ_instance_U536 ( .A1(a1[4]), .A2(SQ_instance_n501), .ZN(
        SQ_instance_n503) );
  ...
  NOR2_X1 SQ_instance_U533 ( .A1(SQ_instance_n498), .A2(SQ_instance_n497), 
        .ZN(SQ_instance_n500) );
  NOR2_X1 SQ_instance_U532 ( .A1(a1[3]), .A2(SQ_instance_n502), .ZN(
        SQ_instance_n497) );
  ...
  NAND2_X1 SQ_instance_U529 ( .A1(SQ_instance_n495), .A2(SQ_instance_n494), 
        .ZN(SQ_instance_n496) );
  NAND2_X1 SQ_instance_U528 ( .A1(a1[3]), .A2(SQ_instance_n493), .ZN(
        SQ_instance_n495) );
  ...
  OR2_X1 SQ_instance_U526 ( .A1(SQ_instance_n501), .A2(SQ_instance_n494), .ZN(
        SQ_instance_n504) );
  NAND2_X1 SQ_instance_U525 ( .A1(a1[2]), .A2(a1[4]), .ZN(SQ_instance_n494) );
  ...
  XOR2_X1 SQ_instance_U516 ( .A(SQ_instance_n491), .B(SQ_instance_n481), .Z(
        SQ_instance_n517) );
  NAND2_X1 SQ_instance_U515 ( .A1(a1[3]), .A2(SQ_instance_n492), .ZN(
        SQ_instance_n481) );
  NAND2_X1 SQ_instance_U514 ( .A1(a1[1]), .A2(a1[4]), .ZN(SQ_instance_n491) );
  ...
  XOR2_X1 SQ_instance_U507 ( .A(SQ_instance_n521), .B(SQ_instance_n520), .Z(
        SQ_instance_n538) );
  XOR2_X1 SQ_instance_U506 ( .A(a1[0]), .B(r1[0]), .Z(SQ_instance_n520) );
  ...
  NOR2_X1 SQ_instance_U496 ( .A1(SQ_instance_n461), .A2(SQ_instance_n460), 
        .ZN(SQ_instance_n462) );
  NAND2_X1 SQ_instance_U495 ( .A1(r1[2]), .A2(a1[1]), .ZN(SQ_instance_n460) );
  NOR2_X1 SQ_instance_U494 ( .A1(SQ_instance_n511), .A2(SQ_instance_n510), 
        .ZN(SQ_instance_n463) );
  OR2_X1 SQ_instance_U493 ( .A1(SQ_instance_n512), .A2(r1[1]), .ZN(
        SQ_instance_n510) );
  NAND2_X1 SQ_instance_U492 ( .A1(SQ_instance_n459), .A2(a1[0]), .ZN(
        SQ_instance_n512) );
  XNOR2_X1 SQ_instance_U491 ( .A(r1[2]), .B(SQ_instance_n458), .ZN(
        SQ_instance_n511) );
  NAND2_X1 SQ_instance_U490 ( .A1(a1[1]), .A2(SQ_instance_n461), .ZN(
        SQ_instance_n458) );
  OR2_X1 SQ_instance_U489 ( .A1(SQ_instance_n509), .A2(SQ_instance_n506), .ZN(
        SQ_instance_n466) );
  XOR2_X1 SQ_instance_U488 ( .A(r1[3]), .B(SQ_instance_n457), .Z(
        SQ_instance_n506) );
  NOR2_X1 SQ_instance_U487 ( .A1(SQ_instance_n456), .A2(r1[2]), .ZN(
        SQ_instance_n509) );
  ...
  XOR2_X1 SQ_instance_U484 ( .A(SQ_instance_n453), .B(SQ_instance_n452), .Z(
        SQ_instance_n454) );
  XNOR2_X1 SQ_instance_U483 ( .A(r1[4]), .B(a1[2]), .ZN(SQ_instance_n472) );
  ...
  OR2_X1 SQ_instance_U480 ( .A1(SQ_instance_n452), .A2(SQ_instance_n453), .ZN(
        SQ_instance_n449) );
  NOR2_X1 SQ_instance_U479 ( .A1(r1[3]), .A2(SQ_instance_n457), .ZN(
        SQ_instance_n455) );
  NAND2_X1 SQ_instance_U478 ( .A1(a1[0]), .A2(a1[2]), .ZN(SQ_instance_n457) );
  ...
  NOR2_X1 SQ_instance_U472 ( .A1(SQ_instance_n456), .A2(SQ_instance_n501), 
        .ZN(SQ_instance_n485) );
  NOR2_X1 SQ_instance_U471 ( .A1(r1[4]), .A2(SQ_instance_n492), .ZN(
        SQ_instance_n482) );
  NOR2_X1 SQ_instance_U470 ( .A1(SQ_instance_n461), .A2(SQ_instance_n498), 
        .ZN(SQ_instance_n483) );
  INV_X1 SQ_instance_U469 ( .A(a1[4]), .ZN(SQ_instance_n498) );
  ...
  NOR2_X1 SQ_instance_U236 ( .A1(SQ_instance_n236), .A2(SQ_instance_n235), 
        .ZN(SQ_instance_n237) );
  XOR2_X1 SQ_instance_U235 ( .A(r1[0]), .B(SQ_instance_n205), .Z(
        SQ_instance_n235) );
  ...
  NOR2_X1 SQ_instance_U219 ( .A1(SQ_instance_n220), .A2(SQ_instance_n223), 
        .ZN(SQ_instance_n188) );
  NAND2_X1 SQ_instance_U218 ( .A1(a0[4]), .A2(SQ_instance_n180), .ZN(
        SQ_instance_n223) );
  ...
  XNOR2_X1 SQ_instance_U166 ( .A(SQ_instance_n149), .B(SQ_instance_n148), .ZN(
        SQ_instance_n117) );
  NAND2_X1 SQ_instance_U165 ( .A1(r1[3]), .A2(SQ_instance_n116), .ZN(
        SQ_instance_n148) );
  NAND2_X1 SQ_instance_U164 ( .A1(a0[0]), .A2(SQ_instance_n180), .ZN(
        SQ_instance_n149) );
  XNOR2_X1 SQ_instance_U163 ( .A(r1[4]), .B(SQ_instance_n115), .ZN(
        SQ_instance_n147) );
  ...
  XOR2_X1 SQ_instance_U157 ( .A(SQ_instance_n129), .B(SQ_instance_n130), .Z(
        SQ_instance_n111) );
  NAND2_X1 SQ_instance_U156 ( .A1(r1[2]), .A2(SQ_instance_n110), .ZN(
        SQ_instance_n130) );
  XNOR2_X1 SQ_instance_U155 ( .A(r1[3]), .B(SQ_instance_n116), .ZN(
        SQ_instance_n129) );
  AND2_X1 SQ_instance_U154 ( .A1(a0[1]), .A2(SQ_instance_n109), .ZN(
        SQ_instance_n116) );
  ...
  XOR2_X1 SQ_instance_U148 ( .A(SQ_instance_n121), .B(SQ_instance_n120), .Z(
        SQ_instance_n102) );
  NAND2_X1 SQ_instance_U147 ( .A1(a0[3]), .A2(SQ_instance_n101), .ZN(
        SQ_instance_n120) );
  NAND2_X1 SQ_instance_U146 ( .A1(a0[2]), .A2(SQ_instance_n100), .ZN(
        SQ_instance_n121) );
  NAND2_X1 SQ_instance_U145 ( .A1(a0[0]), .A2(SQ_instance_n99), .ZN(
        SQ_instance_n119) );
  ...
  AND2_X1 SQ_instance_U138 ( .A1(SQ_instance_n206), .A2(SQ_instance_n209), 
        .ZN(SQ_instance_n93) );
  NAND2_X1 SQ_instance_U137 ( .A1(a0[0]), .A2(SQ_instance_n100), .ZN(
        SQ_instance_n209) );
  OR2_X1 SQ_instance_U136 ( .A1(SQ_instance_n459), .A2(SQ_instance_n205), .ZN(
        SQ_instance_n206) );
  NAND2_X1 SQ_instance_U135 ( .A1(a0[0]), .A2(SQ_instance_n101), .ZN(
        SQ_instance_n205) );
  INV_X1 SQ_instance_U134 ( .A(r1[0]), .ZN(SQ_instance_n459) );
  ...
  AND2_X1 SQ_instance_U132 ( .A1(SQ_instance_n198), .A2(SQ_instance_n197), 
        .ZN(SQ_instance_n98) );
  XOR2_X1 SQ_instance_U131 ( .A(r1[2]), .B(SQ_instance_n110), .Z(
        SQ_instance_n197) );
  AND2_X1 SQ_instance_U130 ( .A1(a0[2]), .A2(SQ_instance_n101), .ZN(
        SQ_instance_n110) );
  ...
  NOR2_X1 SQ_instance_U127 ( .A1(SQ_instance_n513), .A2(SQ_instance_n92), .ZN(
        SQ_instance_n105) );
  NAND2_X1 SQ_instance_U126 ( .A1(a0[1]), .A2(SQ_instance_n101), .ZN(
        SQ_instance_n92) );
  INV_X1 SQ_instance_U125 ( .A(r1[1]), .ZN(SQ_instance_n513) );
  AND2_X1 SQ_instance_U124 ( .A1(a0[1]), .A2(SQ_instance_n100), .ZN(
        SQ_instance_n106) );
  NAND2_X1 SQ_instance_U123 ( .A1(a0[0]), .A2(SQ_instance_n109), .ZN(
        SQ_instance_n104) );
  ...
  AND2_X1 SQ_instance_U115 ( .A1(SQ_instance_n143), .A2(SQ_instance_n142), 
        .ZN(SQ_instance_n85) );
  NAND2_X1 SQ_instance_U114 ( .A1(a0[4]), .A2(SQ_instance_n100), .ZN(
        SQ_instance_n142) );
  NAND2_X1 SQ_instance_U113 ( .A1(a0[3]), .A2(SQ_instance_n109), .ZN(
        SQ_instance_n143) );
  NAND2_X1 SQ_instance_U112 ( .A1(a0[2]), .A2(SQ_instance_n99), .ZN(
        SQ_instance_n145) );
  ...
  NOR2_X1 SQ_instance_U107 ( .A1(SQ_instance_n141), .A2(SQ_instance_n140), 
        .ZN(SQ_instance_n79) );
  NAND2_X1 SQ_instance_U106 ( .A1(SQ_instance_n78), .A2(a0[1]), .ZN(
        SQ_instance_n140) );
  ...
  AND2_X1 SQ_instance_U101 ( .A1(SQ_instance_n125), .A2(SQ_instance_n127), 
        .ZN(SQ_instance_n73) );
  NAND2_X1 SQ_instance_U100 ( .A1(a0[2]), .A2(SQ_instance_n109), .ZN(
        SQ_instance_n127) );
  NAND2_X1 SQ_instance_U99 ( .A1(a0[3]), .A2(SQ_instance_n100), .ZN(
        SQ_instance_n125) );
  XOR2_X1 SQ_instance_U98 ( .A(SQ_instance_n72), .B(SQ_instance_n71), .Z(
        SQ_instance_n100) );
  NAND2_X1 SQ_instance_U97 ( .A1(a0[4]), .A2(SQ_instance_n101), .ZN(
        SQ_instance_n124) );
  ...
  NOR2_X1 SQ_instance_U95 ( .A1(SQ_instance_n68), .A2(SQ_instance_n76), .ZN(
        SQ_instance_n80) );
  NAND2_X1 SQ_instance_U94 ( .A1(r1[4]), .A2(SQ_instance_n115), .ZN(
        SQ_instance_n76) );
  ...
  AND2_X1 SQ_instance_U87 ( .A1(SQ_instance_n82), .A2(SQ_instance_n81), .ZN(
        SQ_instance_n63) );
  NAND2_X1 SQ_instance_U86 ( .A1(a0[4]), .A2(SQ_instance_n109), .ZN(
        SQ_instance_n81) );
  XOR2_X1 SQ_instance_U85 ( .A(SQ_instance_n62), .B(SQ_instance_n61), .Z(
        SQ_instance_n109) );
  NAND2_X1 SQ_instance_U84 ( .A1(a0[3]), .A2(SQ_instance_n99), .ZN(
        SQ_instance_n82) );
  INV_X1 SQ_instance_U83 ( .A(SQ_instance_n67), .ZN(SQ_instance_n99) );
  NAND2_X1 SQ_instance_U82 ( .A1(a0[2]), .A2(SQ_instance_n180), .ZN(
        SQ_instance_n84) );
  ...
  XNOR2_X1 SQ_instance_U72 ( .A(SQ_instance_n52), .B(SQ_instance_n51), .ZN(
        SQ_instance_n71) );
  XOR2_X1 SQ_instance_U71 ( .A(a0[1]), .B(r0[1]), .Z(SQ_instance_n51) );
  NOR2_X1 SQ_instance_U70 ( .A1(SQ_instance_n70), .A2(SQ_instance_n69), .ZN(
        SQ_instance_n72) );
  XNOR2_X1 SQ_instance_U69 ( .A(r0[0]), .B(SQ_instance_n50), .ZN(
        SQ_instance_n69) );
  ...
  AND2_X1 SQ_instance_U67 ( .A1(SQ_instance_n53), .A2(SQ_instance_n55), .ZN(
        SQ_instance_n48) );
  XOR2_X1 SQ_instance_U66 ( .A(a0[4]), .B(SQ_instance_n47), .Z(SQ_instance_n55) );
  ...
  NAND2_X1 SQ_instance_U64 ( .A1(SQ_instance_n44), .A2(SQ_instance_n43), .ZN(
        SQ_instance_n45) );
  NAND2_X1 SQ_instance_U63 ( .A1(SQ_instance_n42), .A2(a0[3]), .ZN(
        SQ_instance_n43) );
  INV_X1 SQ_instance_U62 ( .A(SQ_instance_n41), .ZN(SQ_instance_n44) );
  NAND2_X1 SQ_instance_U61 ( .A1(r0[3]), .A2(SQ_instance_n57), .ZN(
        SQ_instance_n46) );
  NOR2_X1 SQ_instance_U60 ( .A1(r0[4]), .A2(SQ_instance_n60), .ZN(
        SQ_instance_n49) );
  INV_X1 SQ_instance_U59 ( .A(a0[4]), .ZN(SQ_instance_n60) );
  XNOR2_X1 SQ_instance_U58 ( .A(SQ_instance_n40), .B(SQ_instance_n39), .ZN(
        SQ_instance_n62) );
  XNOR2_X1 SQ_instance_U57 ( .A(a0[2]), .B(r0[2]), .ZN(SQ_instance_n39) );
  XNOR2_X1 SQ_instance_U56 ( .A(r0[3]), .B(SQ_instance_n38), .ZN(
        SQ_instance_n59) );
  XNOR2_X1 SQ_instance_U55 ( .A(a0[3]), .B(SQ_instance_n41), .ZN(
        SQ_instance_n38) );
  NOR2_X1 SQ_instance_U54 ( .A1(SQ_instance_n37), .A2(SQ_instance_n36), .ZN(
        SQ_instance_n41) );
  NOR2_X1 SQ_instance_U53 ( .A1(a0[2]), .A2(SQ_instance_n35), .ZN(
        SQ_instance_n36) );
  NOR2_X1 SQ_instance_U52 ( .A1(SQ_instance_n40), .A2(SQ_instance_n34), .ZN(
        SQ_instance_n37) );
  AND2_X1 SQ_instance_U51 ( .A1(SQ_instance_n35), .A2(a0[2]), .ZN(
        SQ_instance_n34) );
  NOR2_X1 SQ_instance_U50 ( .A1(SQ_instance_n33), .A2(SQ_instance_n32), .ZN(
        SQ_instance_n40) );
  NOR2_X1 SQ_instance_U49 ( .A1(a0[1]), .A2(SQ_instance_n31), .ZN(
        SQ_instance_n32) );
  NOR2_X1 SQ_instance_U48 ( .A1(SQ_instance_n52), .A2(SQ_instance_n30), .ZN(
        SQ_instance_n33) );
  NOR2_X1 SQ_instance_U47 ( .A1(r0[1]), .A2(SQ_instance_n77), .ZN(
        SQ_instance_n30) );
  INV_X1 SQ_instance_U46 ( .A(a0[1]), .ZN(SQ_instance_n77) );
  NOR2_X1 SQ_instance_U45 ( .A1(r0[0]), .A2(SQ_instance_n50), .ZN(
        SQ_instance_n52) );
  INV_X1 SQ_instance_U44 ( .A(a0[0]), .ZN(SQ_instance_n50) );
  INV_X1 SQ_instance_U43 ( .A(a0[3]), .ZN(SQ_instance_n57) );
  ...
  XNOR2_X1 SQ_instance_U38 ( .A(SQ_instance_n492), .B(SQ_instance_n23), .ZN(
        SQ_instance_n24) );
  XNOR2_X1 SQ_instance_U37 ( .A(r0[3]), .B(SQ_instance_n22), .ZN(
        SQ_instance_n23) );
  ...
  XNOR2_X1 SQ_instance_U33 ( .A(SQ_instance_n17), .B(SQ_instance_n16), .ZN(
        SQ_instance_n21) );
  XNOR2_X1 SQ_instance_U32 ( .A(r0[2]), .B(a1[1]), .ZN(SQ_instance_n16) );
  ...
  XNOR2_X1 SQ_instance_U29 ( .A(SQ_instance_n13), .B(SQ_instance_n12), .ZN(
        SQ_instance_n19) );
  XNOR2_X1 SQ_instance_U28 ( .A(r0[1]), .B(SQ_instance_n461), .ZN(
        SQ_instance_n12) );
  XOR2_X1 SQ_instance_U27 ( .A(SQ_instance_n15), .B(SQ_instance_n14), .Z(
        SQ_instance_a12r0[0]) );
  XNOR2_X1 SQ_instance_U26 ( .A(r0[0]), .B(a1[4]), .ZN(SQ_instance_n14) );
  ...
  NOR2_X1 SQ_instance_U22 ( .A1(SQ_instance_n42), .A2(SQ_instance_n492), .ZN(
        SQ_instance_n8) );
  INV_X1 SQ_instance_U21 ( .A(a1[2]), .ZN(SQ_instance_n492) );
  INV_X1 SQ_instance_U20 ( .A(r0[3]), .ZN(SQ_instance_n42) );
  ...
  NOR2_X1 SQ_instance_U16 ( .A1(SQ_instance_n17), .A2(SQ_instance_n4), .ZN(
        SQ_instance_n5) );
  NOR2_X1 SQ_instance_U15 ( .A1(r0[2]), .A2(a1[1]), .ZN(SQ_instance_n4) );
  ...
  NOR2_X1 SQ_instance_U13 ( .A1(SQ_instance_n31), .A2(SQ_instance_n461), .ZN(
        SQ_instance_n2) );
  INV_X1 SQ_instance_U12 ( .A(a1[0]), .ZN(SQ_instance_n461) );
  INV_X1 SQ_instance_U11 ( .A(r0[1]), .ZN(SQ_instance_n31) );
  NOR2_X1 SQ_instance_U10 ( .A1(SQ_instance_n13), .A2(SQ_instance_n1), .ZN(
        SQ_instance_n3) );
  NOR2_X1 SQ_instance_U9 ( .A1(r0[1]), .A2(a1[0]), .ZN(SQ_instance_n1) );
  NAND2_X1 SQ_instance_U8 ( .A1(r0[0]), .A2(a1[4]), .ZN(SQ_instance_n13) );
  NOR2_X1 SQ_instance_U7 ( .A1(SQ_instance_n35), .A2(SQ_instance_n456), .ZN(
        SQ_instance_n6) );
  INV_X1 SQ_instance_U6 ( .A(a1[1]), .ZN(SQ_instance_n456) );
  INV_X1 SQ_instance_U5 ( .A(r0[2]), .ZN(SQ_instance_n35) );
  XNOR2_X1 SQ_instance_U4 ( .A(r0[4]), .B(a1[3]), .ZN(SQ_instance_n29) );
  NOR2_X1 SQ_instance_U3 ( .A1(SQ_instance_n47), .A2(SQ_instance_n501), .ZN(
        SQ_instance_n11) );
  INV_X1 SQ_instance_U2 ( .A(a1[3]), .ZN(SQ_instance_n501) );
  INV_X1 SQ_instance_U1 ( .A(r0[4]), .ZN(SQ_instance_n47) );
