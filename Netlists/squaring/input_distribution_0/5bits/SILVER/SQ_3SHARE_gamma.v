...
(* SILVER="clock" *)  input clk;
  ...
  NAND2_X1 U43 ( .A1(r4[1]), .A2(r4[4]), .ZN(n21) );
  NAND2_X1 U44 ( .A1(r4[3]), .A2(r4[0]), .ZN(n20) );
  NOR2_X1 U45 ( .A1(n21), .A2(n20), .ZN(n22) );
  AND2_X1 U46 ( .A1(r4[2]), .A2(n22), .ZN(N22) );
  ...
  NAND2_X1 U55 ( .A1(r0[1]), .A2(r0[4]), .ZN(n30) );
  NAND2_X1 U56 ( .A1(r0[3]), .A2(r0[0]), .ZN(n29) );
  NOR2_X1 U57 ( .A1(n30), .A2(n29), .ZN(n31) );
  AND2_X1 U58 ( .A1(r0[2]), .A2(n31), .ZN(N6) );
  NAND2_X1 U59 ( .A1(r3[1]), .A2(r3[4]), .ZN(n33) );
  NAND2_X1 U60 ( .A1(r3[3]), .A2(r3[0]), .ZN(n32) );
  NOR2_X1 U61 ( .A1(n33), .A2(n32), .ZN(n34) );
  AND2_X1 U62 ( .A1(r3[2]), .A2(n34), .ZN(N18) );
  NOR2_X1 U63 ( .A1(r4_p_r), .A2(r3_p_r), .ZN(n36) );
  NOR2_X1 U64 ( .A1(r2_p_r), .A2(r1_p_r), .ZN(n35) );
  NAND2_X1 U65 ( .A1(n36), .A2(n35), .ZN(n37) );
  AND2_X1 U66 ( .A1(n38), .A2(a1_mod_r[2]), .ZN(a1_sel_r[2]) );
  AND2_X1 U67 ( .A1(n38), .A2(a2_mod_r[0]), .ZN(a2_sel_r[0]) );
  AND2_X1 U68 ( .A1(n38), .A2(a2_mod_r[4]), .ZN(a2_sel_r[4]) );
  AND2_X1 U69 ( .A1(n38), .A2(a0_mod_r[2]), .ZN(a0_sel_r[2]) );
  AND2_X1 U70 ( .A1(n38), .A2(a1_mod_r[0]), .ZN(a1_sel_r[0]) );
  AND2_X1 U71 ( .A1(n38), .A2(a0_mod_r[4]), .ZN(a0_sel_r[4]) );
  AND2_X1 U72 ( .A1(n38), .A2(a0_mod_r[3]), .ZN(a0_sel_r[3]) );
  AND2_X1 U73 ( .A1(n38), .A2(a1_mod_r[4]), .ZN(a1_sel_r[4]) );
  AND2_X1 U74 ( .A1(n38), .A2(a0_mod_r[1]), .ZN(a0_sel_r[1]) );
  AND2_X1 U75 ( .A1(n38), .A2(a0_mod_r[0]), .ZN(a0_sel_r[0]) );
  AND2_X1 U76 ( .A1(n38), .A2(a1_mod_r[1]), .ZN(a1_sel_r[1]) );
  AND2_X1 U77 ( .A1(n38), .A2(a1_mod_r[3]), .ZN(a1_sel_r[3]) );
  AND2_X1 U78 ( .A1(n38), .A2(a2_mod_r[3]), .ZN(a2_sel_r[3]) );
  AND2_X1 U79 ( .A1(n38), .A2(a2_mod_r[1]), .ZN(a2_sel_r[1]) );
  AND2_X1 U80 ( .A1(n38), .A2(a2_mod_r[2]), .ZN(a2_sel_r[2]) );
  ...
  AND2_X1 RED1_U6 ( .A1(a0_r[2]), .A2(RED1_n4), .ZN(a0_mod_r[2]) );
  ...
  AND2_X1 RED2_U9 ( .A1(a1_r[3]), .A2(RED2_n4), .ZN(a1_mod_r[3]) );
