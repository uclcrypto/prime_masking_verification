module SQ_3SHARE_SILVERWRAP ( clk, a0, a1, a2, r0, r1, r2, r3, r4, b0, b1, b2
  ...
  AND2_X1 U66 ( .A1(n38), .A2(a2_mod_r[3]), .ZN(a2_sel_r[3]) );
  AND2_X1 U67 ( .A1(n38), .A2(a2_mod_r[1]), .ZN(a2_sel_r[1]) );
  AND2_X1 U68 ( .A1(n38), .A2(a2_mod_r[2]), .ZN(a2_sel_r[2]) );
  AND2_X1 U69 ( .A1(n38), .A2(a1_mod_r[4]), .ZN(a1_sel_r[4]) );
  AND2_X1 U70 ( .A1(n38), .A2(a2_mod_r[4]), .ZN(a2_sel_r[4]) );
  AND2_X1 U71 ( .A1(n38), .A2(a1_mod_r[0]), .ZN(a1_sel_r[0]) );
  AND2_X1 U72 ( .A1(n38), .A2(a0_mod_r[4]), .ZN(a0_sel_r[4]) );
  AND2_X1 U73 ( .A1(n38), .A2(a0_mod_r[3]), .ZN(a0_sel_r[3]) );
  AND2_X1 U74 ( .A1(n38), .A2(a0_mod_r[2]), .ZN(a0_sel_r[2]) );
  AND2_X1 U75 ( .A1(n38), .A2(a0_mod_r[1]), .ZN(a0_sel_r[1]) );
  AND2_X1 U76 ( .A1(n38), .A2(a0_mod_r[0]), .ZN(a0_sel_r[0]) );
  AND2_X1 U77 ( .A1(n38), .A2(a1_mod_r[1]), .ZN(a1_sel_r[1]) );
  AND2_X1 U78 ( .A1(n38), .A2(a1_mod_r[3]), .ZN(a1_sel_r[3]) );
  AND2_X1 U79 ( .A1(n38), .A2(a1_mod_r[2]), .ZN(a1_sel_r[2]) );
  AND2_X1 U80 ( .A1(n38), .A2(a2_mod_r[0]), .ZN(a2_sel_r[0]) );
  ...
  AND2_X1 RED2_U9 ( .A1(a1_r[2]), .A2(RED2_n4), .ZN(a1_mod_r[2]) );
  AND2_X1 RED2_U8 ( .A1(a1_r[3]), .A2(RED2_n4), .ZN(a1_mod_r[3]) );
  AND2_X1 RED2_U7 ( .A1(a1_r[1]), .A2(RED2_n4), .ZN(a1_mod_r[1]) );
  ...
  AND2_X1 RED3_U8 ( .A1(a2_r[2]), .A2(RED3_n4), .ZN(a2_mod_r[2]) );
  AND2_X1 RED3_U7 ( .A1(a2_r[1]), .A2(RED3_n4), .ZN(a2_mod_r[1]) );
