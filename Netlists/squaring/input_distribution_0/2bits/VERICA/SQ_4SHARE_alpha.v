module SQ_4SHARE_SILVERWRAP ( clk, a0, a1, a2, a3, r0, r1, r2, r3, r4, r5, r6, 
  ...
  wire   N4, N5, N6, N7, N8, N9, N10, N11, N12, N13, N14, N15, r0_p_r, r1_p_r,
         ...
         n22, RED1_n1, RED2_n1, RED3_n1, RED4_n1, SQ_instance_n532,
  ...
  AND2_X1 U57 ( .A1(n22), .A2(a2_mod_r[1]), .ZN(a2_sel_r[1]) );
  AND2_X1 U58 ( .A1(n22), .A2(a1_mod_r[1]), .ZN(a1_sel_r[1]) );
  AND2_X1 U59 ( .A1(n22), .A2(a2_mod_r[0]), .ZN(a2_sel_r[0]) );
  AND2_X1 U60 ( .A1(n22), .A2(a0_mod_r[1]), .ZN(a0_sel_r[1]) );
  AND2_X1 U61 ( .A1(n22), .A2(a3_mod_r[1]), .ZN(a3_sel_r[1]) );
  AND2_X1 U62 ( .A1(n22), .A2(a3_mod_r[0]), .ZN(a3_sel_r[0]) );
  AND2_X1 U63 ( .A1(n22), .A2(a1_mod_r[0]), .ZN(a1_sel_r[0]) );
  AND2_X1 U64 ( .A1(n22), .A2(a0_mod_r[0]), .ZN(a0_sel_r[0]) );
