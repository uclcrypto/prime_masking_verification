...
(* SILVER="clock" *)  input clk;
  wire   N4, N5, N6, N7, N8, N9, N10, N11, N12, N13, N14, N15, r0_p_r, r1_p_r,
         ...
         n22, RED1_n1, RED2_n1, RED3_n1, RED4_n1, SQ_instance_n569,
  ...
  AND2_X1 U34 ( .A1(r4[1]), .A2(r4[0]), .ZN(N8) );
  AND2_X1 U35 ( .A1(r5[1]), .A2(r5[0]), .ZN(N9) );
  AND2_X1 U36 ( .A1(r6[1]), .A2(r6[0]), .ZN(N10) );
  AND2_X1 U37 ( .A1(r7[1]), .A2(r7[0]), .ZN(N11) );
  AND2_X1 U38 ( .A1(r8[1]), .A2(r8[0]), .ZN(N12) );
  AND2_X1 U39 ( .A1(r9[1]), .A2(r9[0]), .ZN(N13) );
  AND2_X1 U40 ( .A1(r10[1]), .A2(r10[0]), .ZN(N14) );
  AND2_X1 U41 ( .A1(r0[1]), .A2(r0[0]), .ZN(N4) );
  AND2_X1 U42 ( .A1(r1[1]), .A2(r1[0]), .ZN(N5) );
  AND2_X1 U43 ( .A1(r2[1]), .A2(r2[0]), .ZN(N6) );
  AND2_X1 U44 ( .A1(r3[1]), .A2(r3[0]), .ZN(N7) );
  AND2_X1 U45 ( .A1(r11[1]), .A2(r11[0]), .ZN(N15) );
  ...
  AND2_X1 U57 ( .A1(n22), .A2(a0_mod_r[1]), .ZN(a0_sel_r[1]) );
  AND2_X1 U58 ( .A1(n22), .A2(a1_mod_r[1]), .ZN(a1_sel_r[1]) );
  AND2_X1 U59 ( .A1(n22), .A2(a1_mod_r[0]), .ZN(a1_sel_r[0]) );
  AND2_X1 U60 ( .A1(n22), .A2(a2_mod_r[1]), .ZN(a2_sel_r[1]) );
  AND2_X1 U61 ( .A1(n22), .A2(a2_mod_r[0]), .ZN(a2_sel_r[0]) );
  AND2_X1 U62 ( .A1(n22), .A2(a0_mod_r[0]), .ZN(a0_sel_r[0]) );
  AND2_X1 U63 ( .A1(n22), .A2(a3_mod_r[1]), .ZN(a3_sel_r[1]) );
  AND2_X1 U64 ( .A1(n22), .A2(a3_mod_r[0]), .ZN(a3_sel_r[0]) );
