module SQ_2SHARE_PROLEADWRAP ( clk, a0, a1, r0, r1, b0, b1 );
  ...
  output [1:0] b1;
  input clk;
  wire   SQ_instance_n94, SQ_instance_n93, SQ_instance_n92, SQ_instance_n91,
         ...
         SQ_instance_add_x_7_n6, SQ_instance_add_x_12_n6, SQ_instance_a1sr1_1_,
  ...
  NOR2_X1 SQ_instance_U101 ( .A1(SQ_instance_n92), .A2(SQ_instance_n91), .ZN(
        SQ_instance_n93) );
  NAND2_X1 SQ_instance_U100 ( .A1(r1[0]), .A2(SQ_instance_n90), .ZN(
        SQ_instance_n91) );
  NAND2_X1 SQ_instance_U99 ( .A1(r1[1]), .A2(SQ_instance_n89), .ZN(
        SQ_instance_n90) );
  ...
  NOR2_X1 SQ_instance_U85 ( .A1(SQ_instance_n72), .A2(SQ_instance_n71), .ZN(
        SQ_instance_n69) );
  XOR2_X1 SQ_instance_U84 ( .A(r0[0]), .B(a1[1]), .Z(SQ_instance_n72) );
  ...
  NAND2_X1 SQ_instance_U82 ( .A1(SQ_instance_n67), .A2(SQ_instance_n71), .ZN(
        SQ_instance_n64) );
  NAND2_X1 SQ_instance_U81 ( .A1(r0[1]), .A2(a1[0]), .ZN(SQ_instance_n71) );
  AND2_X1 SQ_instance_U80 ( .A1(r0[0]), .A2(a1[1]), .ZN(SQ_instance_n67) );
  NOR2_X1 SQ_instance_U79 ( .A1(r0[1]), .A2(a1[0]), .ZN(SQ_instance_n65) );
  ...
  OR2_X1 SQ_instance_U61 ( .A1(SQ_instance_n88), .A2(SQ_instance_n44), .ZN(
        SQ_instance_n52) );
  INV_X1 SQ_instance_U60 ( .A(r1[1]), .ZN(SQ_instance_n88) );
  ...
  NOR2_X1 SQ_instance_U55 ( .A1(SQ_instance_n40), .A2(SQ_instance_n39), .ZN(
        SQ_instance_n49) );
  XNOR2_X1 SQ_instance_U54 ( .A(r1[1]), .B(SQ_instance_n44), .ZN(
        SQ_instance_n46) );
  NAND2_X1 SQ_instance_U53 ( .A1(a0[1]), .A2(SQ_instance_n38), .ZN(
        SQ_instance_n44) );
  NAND2_X1 SQ_instance_U52 ( .A1(a0[0]), .A2(SQ_instance_n37), .ZN(
        SQ_instance_n47) );
  NAND2_X1 SQ_instance_U51 ( .A1(a0[1]), .A2(SQ_instance_n37), .ZN(
        SQ_instance_n53) );
  ...
  XNOR2_X1 SQ_instance_U48 ( .A(SQ_instance_n32), .B(SQ_instance_n31), .ZN(
        SQ_instance_n36) );
  XNOR2_X1 SQ_instance_U47 ( .A(r1[0]), .B(SQ_instance_n39), .ZN(
        SQ_instance_n50) );
  NAND2_X1 SQ_instance_U46 ( .A1(a0[0]), .A2(SQ_instance_n38), .ZN(
        SQ_instance_n39) );
  ...
  NAND2_X1 SQ_instance_U44 ( .A1(SQ_instance_n31), .A2(SQ_instance_n32), .ZN(
        SQ_instance_n29) );
  NOR2_X1 SQ_instance_U43 ( .A1(r0[0]), .A2(SQ_instance_n28), .ZN(
        SQ_instance_n32) );
  INV_X1 SQ_instance_U42 ( .A(a0[0]), .ZN(SQ_instance_n28) );
  XNOR2_X1 SQ_instance_U41 ( .A(a0[1]), .B(r0[1]), .ZN(SQ_instance_n31) );
  XNOR2_X1 SQ_instance_U40 ( .A(SQ_instance_n33), .B(SQ_instance_n34), .ZN(
        SQ_instance_n30) );
  NAND2_X1 SQ_instance_U39 ( .A1(SQ_instance_n27), .A2(a0[1]), .ZN(
        SQ_instance_n34) );
  INV_X1 SQ_instance_U38 ( .A(r0[1]), .ZN(SQ_instance_n27) );
  XOR2_X1 SQ_instance_U37 ( .A(a0[0]), .B(r0[0]), .Z(SQ_instance_n33) );
  ...
  NAND2_X1 SQ_instance_U6 ( .A1(r1[0]), .A2(SQ_instance_n89), .ZN(
        SQ_instance_n1) );
  AND2_X1 SQ_instance_U5 ( .A1(a1[0]), .A2(a1[1]), .ZN(SQ_instance_n89) );
  XNOR2_X1 SQ_instance_U4 ( .A(SQ_instance_n87), .B(r1[1]), .ZN(SQ_instance_n2) );
  NAND2_X1 SQ_instance_U3 ( .A1(SQ_instance_n92), .A2(SQ_instance_n40), .ZN(
        SQ_instance_n87) );
  INV_X1 SQ_instance_U2 ( .A(r1[0]), .ZN(SQ_instance_n40) );
  XOR2_X1 SQ_instance_U1 ( .A(a1[0]), .B(a1[1]), .Z(SQ_instance_n92) );
