module SQ_3SHARE_PROLEADWRAP ( clk, a0, a1, a2, r0, r1, r2, r3, r4, b0, b1, b2
  ...
  output [1:0] b2;
  input clk;
  wire   SQ_instance_n258, SQ_instance_n257, SQ_instance_n256,
         ...
         SQ_instance_add_x_8_n6, SQ_instance_add_x_16_n6,
         SQ_instance_add_x_18_n6, SQ_instance_add_x_21_n6,
  ...
  NOR2_X1 SQ_instance_U235 ( .A1(SQ_instance_n208), .A2(SQ_instance_n207), 
        .ZN(SQ_instance_n205) );
  XOR2_X1 SQ_instance_U234 ( .A(r0[0]), .B(a1[1]), .Z(SQ_instance_n208) );
  ...
  NAND2_X1 SQ_instance_U232 ( .A1(SQ_instance_n192), .A2(SQ_instance_n207), 
        .ZN(SQ_instance_n189) );
  NAND2_X1 SQ_instance_U231 ( .A1(a1[0]), .A2(r0[1]), .ZN(SQ_instance_n207) );
  AND2_X1 SQ_instance_U230 ( .A1(a1[1]), .A2(r0[0]), .ZN(SQ_instance_n192) );
  NOR2_X1 SQ_instance_U229 ( .A1(a1[0]), .A2(r0[1]), .ZN(SQ_instance_n190) );
  ...
  NOR2_X1 SQ_instance_U225 ( .A1(SQ_instance_n214), .A2(SQ_instance_n213), 
        .ZN(SQ_instance_n211) );
  XNOR2_X1 SQ_instance_U224 ( .A(r1[0]), .B(SQ_instance_n184), .ZN(
        SQ_instance_n214) );
  ...
  NAND2_X1 SQ_instance_U222 ( .A1(SQ_instance_n187), .A2(SQ_instance_n213), 
        .ZN(SQ_instance_n183) );
  NAND2_X1 SQ_instance_U221 ( .A1(a2[0]), .A2(r1[1]), .ZN(SQ_instance_n213) );
  AND2_X1 SQ_instance_U220 ( .A1(a2[1]), .A2(r1[0]), .ZN(SQ_instance_n187) );
  NOR2_X1 SQ_instance_U219 ( .A1(a2[0]), .A2(r1[1]), .ZN(SQ_instance_n185) );
  ...
  NOR2_X1 SQ_instance_U215 ( .A1(SQ_instance_n220), .A2(SQ_instance_n219), 
        .ZN(SQ_instance_n217) );
  XOR2_X1 SQ_instance_U214 ( .A(r2[0]), .B(a0[1]), .Z(SQ_instance_n220) );
  ...
  NAND2_X1 SQ_instance_U212 ( .A1(SQ_instance_n181), .A2(SQ_instance_n219), 
        .ZN(SQ_instance_n178) );
  NAND2_X1 SQ_instance_U211 ( .A1(r2[1]), .A2(a0[0]), .ZN(SQ_instance_n219) );
  AND2_X1 SQ_instance_U210 ( .A1(r2[0]), .A2(a0[1]), .ZN(SQ_instance_n181) );
  NOR2_X1 SQ_instance_U209 ( .A1(r2[1]), .A2(a0[0]), .ZN(SQ_instance_n179) );
  ...
  XNOR2_X1 SQ_instance_U192 ( .A(SQ_instance_n169), .B(SQ_instance_n167), .ZN(
        SQ_instance_n160) );
  NAND2_X1 SQ_instance_U191 ( .A1(a0[1]), .A2(SQ_instance_n159), .ZN(
        SQ_instance_n167) );
  XOR2_X1 SQ_instance_U190 ( .A(r0[1]), .B(SQ_instance_n158), .Z(
        SQ_instance_n159) );
  ...
  XOR2_X1 SQ_instance_U184 ( .A(SQ_instance_r3_rr[0]), .B(SQ_instance_n155), 
        .Z(SQ_instance_n162) );
  AND2_X1 SQ_instance_U183 ( .A1(a0[0]), .A2(SQ_instance_n151), .ZN(
        SQ_instance_n155) );
  ...
  XNOR2_X1 SQ_instance_U181 ( .A(SQ_instance_r3_rr[1]), .B(SQ_instance_n152), 
        .ZN(SQ_instance_n153) );
  AND2_X1 SQ_instance_U180 ( .A1(a0[1]), .A2(SQ_instance_n151), .ZN(
        SQ_instance_n152) );
  ...
  OR2_X1 SQ_instance_U178 ( .A1(SQ_instance_n148), .A2(SQ_instance_n147), .ZN(
        SQ_instance_n154) );
  NAND2_X1 SQ_instance_U177 ( .A1(SQ_instance_n146), .A2(a0[0]), .ZN(
        SQ_instance_n147) );
  XOR2_X1 SQ_instance_U176 ( .A(r0[1]), .B(a0[1]), .Z(SQ_instance_n146) );
  NOR2_X1 SQ_instance_U175 ( .A1(SQ_instance_n150), .A2(SQ_instance_n149), 
        .ZN(SQ_instance_n148) );
  NAND2_X1 SQ_instance_U174 ( .A1(r0[1]), .A2(SQ_instance_n145), .ZN(
        SQ_instance_n149) );
  NAND2_X1 SQ_instance_U173 ( .A1(a0[1]), .A2(SQ_instance_n158), .ZN(
        SQ_instance_n145) );
  NAND2_X1 SQ_instance_U172 ( .A1(r0[0]), .A2(SQ_instance_n144), .ZN(
        SQ_instance_n158) );
  INV_X1 SQ_instance_U171 ( .A(a0[0]), .ZN(SQ_instance_n144) );
  XOR2_X1 SQ_instance_U170 ( .A(a0[0]), .B(r0[0]), .Z(SQ_instance_n150) );
  ...
  XNOR2_X1 SQ_instance_U153 ( .A(SQ_instance_n135), .B(SQ_instance_n133), .ZN(
        SQ_instance_n126) );
  NAND2_X1 SQ_instance_U152 ( .A1(a1[1]), .A2(SQ_instance_n125), .ZN(
        SQ_instance_n133) );
  XOR2_X1 SQ_instance_U151 ( .A(r1[1]), .B(SQ_instance_n124), .Z(
        SQ_instance_n125) );
  ...
  XOR2_X1 SQ_instance_U145 ( .A(SQ_instance_r4_rr[0]), .B(SQ_instance_n121), 
        .Z(SQ_instance_n128) );
  AND2_X1 SQ_instance_U144 ( .A1(a1[0]), .A2(SQ_instance_n117), .ZN(
        SQ_instance_n121) );
  ...
  XNOR2_X1 SQ_instance_U142 ( .A(SQ_instance_r4_rr[1]), .B(SQ_instance_n118), 
        .ZN(SQ_instance_n119) );
  AND2_X1 SQ_instance_U141 ( .A1(a1[1]), .A2(SQ_instance_n117), .ZN(
        SQ_instance_n118) );
  ...
  OR2_X1 SQ_instance_U139 ( .A1(SQ_instance_n114), .A2(SQ_instance_n113), .ZN(
        SQ_instance_n120) );
  NAND2_X1 SQ_instance_U138 ( .A1(SQ_instance_n112), .A2(a1[0]), .ZN(
        SQ_instance_n113) );
  XOR2_X1 SQ_instance_U137 ( .A(r1[1]), .B(a1[1]), .Z(SQ_instance_n112) );
  NOR2_X1 SQ_instance_U136 ( .A1(SQ_instance_n116), .A2(SQ_instance_n115), 
        .ZN(SQ_instance_n114) );
  NAND2_X1 SQ_instance_U135 ( .A1(r1[1]), .A2(SQ_instance_n111), .ZN(
        SQ_instance_n115) );
  NAND2_X1 SQ_instance_U134 ( .A1(a1[1]), .A2(SQ_instance_n124), .ZN(
        SQ_instance_n111) );
  NAND2_X1 SQ_instance_U133 ( .A1(r1[0]), .A2(SQ_instance_n110), .ZN(
        SQ_instance_n124) );
  INV_X1 SQ_instance_U132 ( .A(a1[0]), .ZN(SQ_instance_n110) );
  XOR2_X1 SQ_instance_U131 ( .A(a1[0]), .B(r1[0]), .Z(SQ_instance_n116) );
  ...
  XOR2_X1 SQ_instance_U111 ( .A(SQ_instance_n87), .B(SQ_instance_n100), .Z(
        SQ_instance_n97) );
  AND2_X1 SQ_instance_U110 ( .A1(SQ_instance_n86), .A2(a2[1]), .ZN(
        SQ_instance_n100) );
  XOR2_X1 SQ_instance_U109 ( .A(SQ_instance_n85), .B(r2[1]), .Z(
        SQ_instance_n86) );
  ...
  NOR2_X1 SQ_instance_U105 ( .A1(SQ_instance_r5_rr[0]), .A2(SQ_instance_n94), 
        .ZN(SQ_instance_n89) );
  NAND2_X1 SQ_instance_U104 ( .A1(a2[0]), .A2(SQ_instance_n83), .ZN(
        SQ_instance_n94) );
  ...
  NOR2_X1 SQ_instance_U102 ( .A1(SQ_instance_n80), .A2(SQ_instance_n79), .ZN(
        SQ_instance_n81) );
  NOR2_X1 SQ_instance_U101 ( .A1(r2[0]), .A2(SQ_instance_n78), .ZN(
        SQ_instance_n79) );
  NAND2_X1 SQ_instance_U100 ( .A1(r2[1]), .A2(SQ_instance_n184), .ZN(
        SQ_instance_n78) );
  XOR2_X1 SQ_instance_U99 ( .A(SQ_instance_r5_rr[1]), .B(SQ_instance_n99), .Z(
        SQ_instance_n88) );
  NAND2_X1 SQ_instance_U98 ( .A1(a2[1]), .A2(SQ_instance_n83), .ZN(
        SQ_instance_n99) );
  ...
  NAND2_X1 SQ_instance_U95 ( .A1(SQ_instance_n73), .A2(SQ_instance_n85), .ZN(
        SQ_instance_n74) );
  NAND2_X1 SQ_instance_U94 ( .A1(r2[0]), .A2(SQ_instance_n82), .ZN(
        SQ_instance_n85) );
  INV_X1 SQ_instance_U93 ( .A(a2[0]), .ZN(SQ_instance_n82) );
  XNOR2_X1 SQ_instance_U92 ( .A(a2[1]), .B(r2[1]), .ZN(SQ_instance_n73) );
  INV_X1 SQ_instance_U91 ( .A(SQ_instance_n80), .ZN(SQ_instance_n75) );
  NOR2_X1 SQ_instance_U90 ( .A1(r2[1]), .A2(SQ_instance_n184), .ZN(
        SQ_instance_n80) );
  INV_X1 SQ_instance_U89 ( .A(a2[1]), .ZN(SQ_instance_n184) );
  XOR2_X1 SQ_instance_U88 ( .A(a2[0]), .B(r2[0]), .Z(SQ_instance_n77) );
