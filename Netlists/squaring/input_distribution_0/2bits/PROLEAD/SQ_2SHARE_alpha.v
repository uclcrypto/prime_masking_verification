module SQ_2SHARE_PROLEADWRAP ( clk, a0, a1, r0, r1, b0, b1 );
  ...
  output [1:0] b1;
  input clk;
  wire   SQ_instance_n97, SQ_instance_n96, SQ_instance_n95, SQ_instance_n94,
         ...
         SQ_instance_n1, SQ_instance_add_x_2_n6, SQ_instance_add_x_6_n6,
  ...
  NAND2_X1 SQ_instance_U104 ( .A1(SQ_instance_n95), .A2(SQ_instance_n94), .ZN(
        SQ_instance_n96) );
  NAND2_X1 SQ_instance_U103 ( .A1(r1[0]), .A2(SQ_instance_n93), .ZN(
        SQ_instance_n94) );
  NAND2_X1 SQ_instance_U102 ( .A1(SQ_instance_n92), .A2(r1[1]), .ZN(
        SQ_instance_n93) );
  NAND2_X1 SQ_instance_U101 ( .A1(SQ_instance_n91), .A2(SQ_instance_n90), .ZN(
        SQ_instance_n97) );
  NAND2_X1 SQ_instance_U100 ( .A1(r1[1]), .A2(SQ_instance_n89), .ZN(
        SQ_instance_n90) );
  ...
  NOR2_X1 SQ_instance_U87 ( .A1(SQ_instance_n74), .A2(SQ_instance_n73), .ZN(
        SQ_instance_n71) );
  XOR2_X1 SQ_instance_U86 ( .A(r0[0]), .B(a1[1]), .Z(SQ_instance_n74) );
  ...
  NAND2_X1 SQ_instance_U84 ( .A1(SQ_instance_n69), .A2(SQ_instance_n73), .ZN(
        SQ_instance_n66) );
  NAND2_X1 SQ_instance_U83 ( .A1(r0[1]), .A2(a1[0]), .ZN(SQ_instance_n73) );
  AND2_X1 SQ_instance_U82 ( .A1(r0[0]), .A2(a1[1]), .ZN(SQ_instance_n69) );
  NOR2_X1 SQ_instance_U81 ( .A1(r0[1]), .A2(a1[0]), .ZN(SQ_instance_n67) );
  ...
  XNOR2_X1 SQ_instance_U64 ( .A(SQ_instance_n55), .B(SQ_instance_n54), .ZN(
        SQ_instance_n47) );
  NAND2_X1 SQ_instance_U63 ( .A1(r1[1]), .A2(SQ_instance_n46), .ZN(
        SQ_instance_n54) );
  NAND2_X1 SQ_instance_U62 ( .A1(a0[1]), .A2(SQ_instance_n45), .ZN(
        SQ_instance_n55) );
  XOR2_X1 SQ_instance_U61 ( .A(r0[1]), .B(SQ_instance_n44), .Z(SQ_instance_n45) );
  ...
  NOR2_X1 SQ_instance_U58 ( .A1(SQ_instance_n89), .A2(SQ_instance_n41), .ZN(
        SQ_instance_n52) );
  INV_X1 SQ_instance_U57 ( .A(r1[0]), .ZN(SQ_instance_n89) );
  NAND2_X1 SQ_instance_U56 ( .A1(SQ_instance_n40), .A2(SQ_instance_n39), .ZN(
        SQ_instance_n43) );
  XNOR2_X1 SQ_instance_U55 ( .A(r1[0]), .B(SQ_instance_n41), .ZN(
        SQ_instance_n50) );
  NAND2_X1 SQ_instance_U54 ( .A1(SQ_instance_n38), .A2(a0[0]), .ZN(
        SQ_instance_n41) );
  XOR2_X1 SQ_instance_U53 ( .A(r0[0]), .B(SQ_instance_n37), .Z(SQ_instance_n38) );
  INV_X1 SQ_instance_U52 ( .A(SQ_instance_n53), .ZN(SQ_instance_n48) );
  XOR2_X1 SQ_instance_U51 ( .A(SQ_instance_n40), .B(SQ_instance_n39), .Z(
        SQ_instance_n53) );
  XOR2_X1 SQ_instance_U50 ( .A(r1[1]), .B(SQ_instance_n46), .Z(SQ_instance_n39) );
  ...
  NAND2_X1 SQ_instance_U46 ( .A1(a0[1]), .A2(SQ_instance_n37), .ZN(
        SQ_instance_n36) );
  NOR2_X1 SQ_instance_U45 ( .A1(SQ_instance_n32), .A2(SQ_instance_n31), .ZN(
        SQ_instance_n40) );
  NAND2_X1 SQ_instance_U44 ( .A1(SQ_instance_n30), .A2(a0[0]), .ZN(
        SQ_instance_n31) );
  XOR2_X1 SQ_instance_U43 ( .A(r0[1]), .B(a0[1]), .Z(SQ_instance_n30) );
  NOR2_X1 SQ_instance_U42 ( .A1(SQ_instance_n33), .A2(SQ_instance_n37), .ZN(
        SQ_instance_n32) );
  NAND2_X1 SQ_instance_U41 ( .A1(r0[1]), .A2(SQ_instance_n29), .ZN(
        SQ_instance_n37) );
  NAND2_X1 SQ_instance_U40 ( .A1(a0[1]), .A2(SQ_instance_n44), .ZN(
        SQ_instance_n29) );
  NAND2_X1 SQ_instance_U39 ( .A1(r0[0]), .A2(SQ_instance_n28), .ZN(
        SQ_instance_n44) );
  NOR2_X1 SQ_instance_U38 ( .A1(r0[0]), .A2(SQ_instance_n28), .ZN(
        SQ_instance_n33) );
  INV_X1 SQ_instance_U37 ( .A(a0[0]), .ZN(SQ_instance_n28) );
  ...
  NAND2_X1 SQ_instance_U6 ( .A1(r1[0]), .A2(SQ_instance_n92), .ZN(
        SQ_instance_n2) );
  AND2_X1 SQ_instance_U5 ( .A1(a1[0]), .A2(a1[1]), .ZN(SQ_instance_n92) );
  XOR2_X1 SQ_instance_U4 ( .A(r1[1]), .B(SQ_instance_n1), .Z(SQ_instance_n3)
         );
  NOR2_X1 SQ_instance_U3 ( .A1(SQ_instance_n95), .A2(r1[0]), .ZN(
        SQ_instance_n1) );
  INV_X1 SQ_instance_U2 ( .A(SQ_instance_n91), .ZN(SQ_instance_n95) );
  XOR2_X1 SQ_instance_U1 ( .A(a1[0]), .B(a1[1]), .Z(SQ_instance_n91) );
