module SQ_3SHARE_PROLEADWRAP ( clk, a0, a1, a2, r0, r1, r2, r3, r4, b0, b1, b2
  ...
  output [1:0] b2;
  input clk;
  wire   SQ_instance_n265, SQ_instance_n264, SQ_instance_n263,
  ...
  NAND2_X1 SQ_instance_U252 ( .A1(SQ_instance_n217), .A2(SQ_instance_n216), 
        .ZN(SQ_instance_n227) );
  NAND2_X1 SQ_instance_U251 ( .A1(a2[1]), .A2(SQ_instance_n215), .ZN(
        SQ_instance_n216) );
  NOR2_X1 SQ_instance_U250 ( .A1(SQ_instance_n214), .A2(SQ_instance_n213), 
        .ZN(SQ_instance_n217) );
  XNOR2_X1 SQ_instance_U249 ( .A(r2[0]), .B(SQ_instance_n212), .ZN(
        SQ_instance_n213) );
  NAND2_X1 SQ_instance_U248 ( .A1(r2[1]), .A2(SQ_instance_n224), .ZN(
        SQ_instance_n212) );
  ...
  OR2_X1 SQ_instance_U245 ( .A1(SQ_instance_n214), .A2(SQ_instance_n210), .ZN(
        SQ_instance_n211) );
  NOR2_X1 SQ_instance_U244 ( .A1(a2[1]), .A2(SQ_instance_n209), .ZN(
        SQ_instance_n210) );
  XOR2_X1 SQ_instance_U243 ( .A(SQ_instance_n208), .B(SQ_instance_n207), .Z(
        SQ_instance_n223) );
  XOR2_X1 SQ_instance_U242 ( .A(a2[1]), .B(r2[1]), .Z(SQ_instance_n207) );
  ...
  OR2_X1 SQ_instance_U240 ( .A1(SQ_instance_n206), .A2(SQ_instance_n205), .ZN(
        SQ_instance_n222) );
  NOR2_X1 SQ_instance_U239 ( .A1(r2[1]), .A2(SQ_instance_n204), .ZN(
        SQ_instance_n205) );
  NAND2_X1 SQ_instance_U238 ( .A1(a2[1]), .A2(SQ_instance_n203), .ZN(
        SQ_instance_n206) );
  ...
  AND2_X1 SQ_instance_U236 ( .A1(SQ_instance_n208), .A2(SQ_instance_n204), 
        .ZN(SQ_instance_n202) );
  NAND2_X1 SQ_instance_U235 ( .A1(SQ_instance_n209), .A2(a2[0]), .ZN(
        SQ_instance_n204) );
  NAND2_X1 SQ_instance_U234 ( .A1(SQ_instance_n214), .A2(r2[0]), .ZN(
        SQ_instance_n208) );
  ...
  NOR2_X1 SQ_instance_U216 ( .A1(SQ_instance_n174), .A2(SQ_instance_n173), 
        .ZN(SQ_instance_n175) );
  NOR2_X1 SQ_instance_U215 ( .A1(r0[1]), .A2(SQ_instance_n172), .ZN(
        SQ_instance_n173) );
  ...
  XNOR2_X1 SQ_instance_U211 ( .A(SQ_instance_r3_rr[0]), .B(SQ_instance_n171), 
        .ZN(SQ_instance_n188) );
  AND2_X1 SQ_instance_U210 ( .A1(a0[0]), .A2(SQ_instance_n170), .ZN(
        SQ_instance_n171) );
  ...
  XNOR2_X1 SQ_instance_U208 ( .A(SQ_instance_r3_rr[1]), .B(SQ_instance_n177), 
        .ZN(SQ_instance_n169) );
  NAND2_X1 SQ_instance_U207 ( .A1(a0[1]), .A2(SQ_instance_n170), .ZN(
        SQ_instance_n177) );
  XOR2_X1 SQ_instance_U206 ( .A(SQ_instance_n168), .B(SQ_instance_n167), .Z(
        SQ_instance_n170) );
  NAND2_X1 SQ_instance_U205 ( .A1(r0[1]), .A2(SQ_instance_n166), .ZN(
        SQ_instance_n167) );
  ...
  NOR2_X1 SQ_instance_U201 ( .A1(SQ_instance_n163), .A2(SQ_instance_n162), 
        .ZN(SQ_instance_n176) );
  NOR2_X1 SQ_instance_U200 ( .A1(r0[1]), .A2(SQ_instance_n161), .ZN(
        SQ_instance_n162) );
  ...
  NAND2_X1 SQ_instance_U198 ( .A1(SQ_instance_n160), .A2(SQ_instance_n172), 
        .ZN(SQ_instance_n166) );
  NAND2_X1 SQ_instance_U197 ( .A1(r0[0]), .A2(SQ_instance_n161), .ZN(
        SQ_instance_n172) );
  NOR2_X1 SQ_instance_U196 ( .A1(SQ_instance_n159), .A2(SQ_instance_n174), 
        .ZN(SQ_instance_n160) );
  INV_X1 SQ_instance_U195 ( .A(a0[1]), .ZN(SQ_instance_n174) );
  NOR2_X1 SQ_instance_U194 ( .A1(r0[0]), .A2(SQ_instance_n161), .ZN(
        SQ_instance_n164) );
  ...
  NOR2_X1 SQ_instance_U182 ( .A1(SQ_instance_n143), .A2(SQ_instance_n142), 
        .ZN(SQ_instance_n144) );
  NOR2_X1 SQ_instance_U181 ( .A1(r1[1]), .A2(SQ_instance_n141), .ZN(
        SQ_instance_n142) );
  ...
  XNOR2_X1 SQ_instance_U177 ( .A(SQ_instance_r4_rr[0]), .B(SQ_instance_n140), 
        .ZN(SQ_instance_n157) );
  AND2_X1 SQ_instance_U176 ( .A1(a1[0]), .A2(SQ_instance_n139), .ZN(
        SQ_instance_n140) );
  ...
  XNOR2_X1 SQ_instance_U174 ( .A(SQ_instance_r4_rr[1]), .B(SQ_instance_n146), 
        .ZN(SQ_instance_n138) );
  NAND2_X1 SQ_instance_U173 ( .A1(a1[1]), .A2(SQ_instance_n139), .ZN(
        SQ_instance_n146) );
  XOR2_X1 SQ_instance_U172 ( .A(SQ_instance_n137), .B(SQ_instance_n136), .Z(
        SQ_instance_n139) );
  NAND2_X1 SQ_instance_U171 ( .A1(r1[1]), .A2(SQ_instance_n135), .ZN(
        SQ_instance_n136) );
  ...
  NOR2_X1 SQ_instance_U167 ( .A1(SQ_instance_n132), .A2(SQ_instance_n131), 
        .ZN(SQ_instance_n145) );
  NOR2_X1 SQ_instance_U166 ( .A1(r1[1]), .A2(SQ_instance_n130), .ZN(
        SQ_instance_n131) );
  ...
  NAND2_X1 SQ_instance_U164 ( .A1(SQ_instance_n129), .A2(SQ_instance_n141), 
        .ZN(SQ_instance_n135) );
  NAND2_X1 SQ_instance_U163 ( .A1(r1[0]), .A2(SQ_instance_n130), .ZN(
        SQ_instance_n141) );
  NOR2_X1 SQ_instance_U162 ( .A1(SQ_instance_n128), .A2(SQ_instance_n143), 
        .ZN(SQ_instance_n129) );
  NOR2_X1 SQ_instance_U161 ( .A1(r1[0]), .A2(SQ_instance_n130), .ZN(
        SQ_instance_n133) );
  ...
  AND2_X1 SQ_instance_U48 ( .A1(SQ_instance_n259), .A2(SQ_instance_n258), .ZN(
        SQ_instance_a02r2[1]) );
  ...
  NAND2_X1 SQ_instance_U44 ( .A1(SQ_instance_n24), .A2(SQ_instance_n23), .ZN(
        SQ_instance_n25) );
  NAND2_X1 SQ_instance_U43 ( .A1(r2[0]), .A2(a0[1]), .ZN(SQ_instance_n24) );
  NOR2_X1 SQ_instance_U42 ( .A1(SQ_instance_n30), .A2(SQ_instance_n29), .ZN(
        SQ_instance_n26) );
  XNOR2_X1 SQ_instance_U41 ( .A(r2[0]), .B(a0[1]), .ZN(SQ_instance_n29) );
  NOR2_X1 SQ_instance_U40 ( .A1(SQ_instance_n22), .A2(SQ_instance_n28), .ZN(
        SQ_instance_n30) );
  NOR2_X1 SQ_instance_U39 ( .A1(SQ_instance_n215), .A2(SQ_instance_n161), .ZN(
        SQ_instance_n22) );
  INV_X1 SQ_instance_U38 ( .A(a0[0]), .ZN(SQ_instance_n161) );
  INV_X1 SQ_instance_U37 ( .A(r2[1]), .ZN(SQ_instance_n215) );
  NOR2_X1 SQ_instance_U36 ( .A1(SQ_instance_n209), .A2(SQ_instance_n23), .ZN(
        SQ_instance_n28) );
  XNOR2_X1 SQ_instance_U35 ( .A(r2[1]), .B(a0[0]), .ZN(SQ_instance_n23) );
  INV_X1 SQ_instance_U34 ( .A(r2[0]), .ZN(SQ_instance_n209) );
  AND2_X1 SQ_instance_U33 ( .A1(SQ_instance_n263), .A2(SQ_instance_n262), .ZN(
        SQ_instance_a12r0[1]) );
  XNOR2_X1 SQ_instance_U32 ( .A(SQ_instance_n21), .B(SQ_instance_n20), .ZN(
        SQ_instance_n262) );
  NOR2_X1 SQ_instance_U31 ( .A1(SQ_instance_n19), .A2(SQ_instance_n18), .ZN(
        SQ_instance_n263) );
  NOR2_X1 SQ_instance_U30 ( .A1(SQ_instance_n17), .A2(SQ_instance_n16), .ZN(
        SQ_instance_n18) );
  NAND2_X1 SQ_instance_U29 ( .A1(SQ_instance_n15), .A2(SQ_instance_n14), .ZN(
        SQ_instance_n16) );
  NAND2_X1 SQ_instance_U28 ( .A1(SQ_instance_n21), .A2(SQ_instance_n20), .ZN(
        SQ_instance_n14) );
  NAND2_X1 SQ_instance_U27 ( .A1(SQ_instance_n13), .A2(SQ_instance_n12), .ZN(
        SQ_instance_n20) );
  NAND2_X1 SQ_instance_U26 ( .A1(a1[0]), .A2(r0[1]), .ZN(SQ_instance_n13) );
  XNOR2_X1 SQ_instance_U25 ( .A(r0[0]), .B(SQ_instance_n143), .ZN(
        SQ_instance_n21) );
  INV_X1 SQ_instance_U24 ( .A(a1[1]), .ZN(SQ_instance_n143) );
  NAND2_X1 SQ_instance_U23 ( .A1(a1[1]), .A2(r0[0]), .ZN(SQ_instance_n15) );
  INV_X1 SQ_instance_U22 ( .A(SQ_instance_n12), .ZN(SQ_instance_n19) );
  NAND2_X1 SQ_instance_U21 ( .A1(r0[0]), .A2(SQ_instance_n17), .ZN(
        SQ_instance_n12) );
  XOR2_X1 SQ_instance_U20 ( .A(SQ_instance_n130), .B(SQ_instance_n159), .Z(
        SQ_instance_n17) );
  INV_X1 SQ_instance_U19 ( .A(r0[1]), .ZN(SQ_instance_n159) );
  INV_X1 SQ_instance_U18 ( .A(a1[0]), .ZN(SQ_instance_n130) );
  AND2_X1 SQ_instance_U17 ( .A1(SQ_instance_n261), .A2(SQ_instance_n260), .ZN(
        SQ_instance_a22r1[1]) );
  XNOR2_X1 SQ_instance_U16 ( .A(SQ_instance_n11), .B(SQ_instance_n10), .ZN(
        SQ_instance_n260) );
  NOR2_X1 SQ_instance_U15 ( .A1(SQ_instance_n9), .A2(SQ_instance_n8), .ZN(
        SQ_instance_n261) );
  NOR2_X1 SQ_instance_U14 ( .A1(SQ_instance_n7), .A2(SQ_instance_n6), .ZN(
        SQ_instance_n8) );
  NAND2_X1 SQ_instance_U13 ( .A1(SQ_instance_n5), .A2(SQ_instance_n4), .ZN(
        SQ_instance_n6) );
  NAND2_X1 SQ_instance_U12 ( .A1(SQ_instance_n11), .A2(SQ_instance_n10), .ZN(
        SQ_instance_n4) );
  NAND2_X1 SQ_instance_U11 ( .A1(SQ_instance_n3), .A2(SQ_instance_n2), .ZN(
        SQ_instance_n10) );
  NAND2_X1 SQ_instance_U10 ( .A1(a2[0]), .A2(r1[1]), .ZN(SQ_instance_n3) );
  XNOR2_X1 SQ_instance_U9 ( .A(r1[0]), .B(SQ_instance_n224), .ZN(
        SQ_instance_n11) );
  INV_X1 SQ_instance_U8 ( .A(a2[1]), .ZN(SQ_instance_n224) );
  NAND2_X1 SQ_instance_U7 ( .A1(a2[1]), .A2(r1[0]), .ZN(SQ_instance_n5) );
  INV_X1 SQ_instance_U6 ( .A(SQ_instance_n2), .ZN(SQ_instance_n9) );
  NAND2_X1 SQ_instance_U5 ( .A1(r1[0]), .A2(SQ_instance_n7), .ZN(
        SQ_instance_n2) );
  XOR2_X1 SQ_instance_U4 ( .A(SQ_instance_n214), .B(SQ_instance_n128), .Z(
        SQ_instance_n7) );
  INV_X1 SQ_instance_U3 ( .A(r1[1]), .ZN(SQ_instance_n128) );
  INV_X1 SQ_instance_U2 ( .A(a2[0]), .ZN(SQ_instance_n214) );
