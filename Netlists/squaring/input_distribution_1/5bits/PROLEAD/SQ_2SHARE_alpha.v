...
module SQ_2SHARE_PROLEADWRAP ( clk, a0, a1, r0, r1, b0, b1 );
  ...
  output [4:0] b1;
  input clk;
  wire   net2091, net2092, net2093, net2094, net2095, net2096, net2097,
         net2098, net2099, net2100, net2101, net2102, net2103, net2104,
         net2105, net2106, net2107, net2108, net2109, net2110, net2111,
         net2112, net2113, net2114, net2115, net2116, net2117, net2118,
         net2119, net2120, Add1_n10, Add1_n9, Add1_n8, Add1_n7, Add1_n6,
         Add2_n10, Add2_n9, Add2_n8, Add2_n7, Add2_n6, Add3_n10, Add3_n9,
         Add3_n8, Add3_n7, Add3_n6, Add4_n10, Add4_n9, Add4_n8, Add4_n7,
         Add4_n6, Sub1_n10, Sub1_n9, Sub1_n8, Sub1_n7, Sub1_n6, Sub2_n10,
         Sub2_n9, Sub2_n8, Sub2_n7, Sub2_n6, SQ_instance_n555,
  ...
  XOR2_X1 Add1_U8 ( .A(Add1_n8), .B(a0[2]), .Z(a0p1[2]) );
  XOR2_X1 Add1_U7 ( .A(a0[0]), .B(a0[1]), .Z(a0p1[1]) );
  NAND2_X1 Add1_U6 ( .A1(a0[0]), .A2(Add1_n7), .ZN(a0p1[0]) );
  NAND2_X1 Add1_U5 ( .A1(Add1_n10), .A2(a0[4]), .ZN(Add1_n7) );
  NOR2_X1 Add1_U4 ( .A1(Add1_n9), .A2(Add1_n6), .ZN(Add1_n10) );
  INV_X1 Add1_U3 ( .A(a0[3]), .ZN(Add1_n6) );
  NAND2_X1 Add1_U2 ( .A1(Add1_n8), .A2(a0[2]), .ZN(Add1_n9) );
  AND2_X1 Add1_U1 ( .A1(a0[0]), .A2(a0[1]), .ZN(Add1_n8) );
  ...
  XOR2_X1 SQ_instance_U542 ( .A(SQ_instance_n513), .B(SQ_instance_n512), .Z(
        SQ_instance_n514) );
  XOR2_X1 SQ_instance_U541 ( .A(r1p1[1]), .B(SQ_instance_n511), .Z(
        SQ_instance_n516) );
  ...
  XOR2_X1 SQ_instance_U535 ( .A(SQ_instance_n502), .B(SQ_instance_n501), .Z(
        SQ_instance_n504) );
  NAND2_X1 SQ_instance_U534 ( .A1(a1p1[4]), .A2(SQ_instance_n500), .ZN(
        SQ_instance_n502) );
  ...
  NOR2_X1 SQ_instance_U531 ( .A1(SQ_instance_n497), .A2(SQ_instance_n496), 
        .ZN(SQ_instance_n499) );
  NOR2_X1 SQ_instance_U530 ( .A1(a1p1[3]), .A2(SQ_instance_n501), .ZN(
        SQ_instance_n496) );
  ...
  NAND2_X1 SQ_instance_U527 ( .A1(SQ_instance_n494), .A2(SQ_instance_n493), 
        .ZN(SQ_instance_n495) );
  NAND2_X1 SQ_instance_U526 ( .A1(a1p1[3]), .A2(SQ_instance_n492), .ZN(
        SQ_instance_n494) );
  ...
  OR2_X1 SQ_instance_U524 ( .A1(SQ_instance_n500), .A2(SQ_instance_n493), .ZN(
        SQ_instance_n503) );
  NAND2_X1 SQ_instance_U523 ( .A1(a1p1[2]), .A2(a1p1[4]), .ZN(SQ_instance_n493) );
  ...
  XOR2_X1 SQ_instance_U514 ( .A(SQ_instance_n490), .B(SQ_instance_n480), .Z(
        SQ_instance_n515) );
  NAND2_X1 SQ_instance_U513 ( .A1(a1p1[3]), .A2(SQ_instance_n491), .ZN(
        SQ_instance_n480) );
  NAND2_X1 SQ_instance_U512 ( .A1(a1p1[1]), .A2(a1p1[4]), .ZN(SQ_instance_n490) );
  ...
  XOR2_X1 SQ_instance_U505 ( .A(SQ_instance_n519), .B(SQ_instance_n518), .Z(
        SQ_instance_n536) );
  XNOR2_X1 SQ_instance_U504 ( .A(SQ_instance_n469), .B(r1p1[0]), .ZN(
        SQ_instance_n518) );
  ...
  NOR2_X1 SQ_instance_U494 ( .A1(SQ_instance_n469), .A2(SQ_instance_n459), 
        .ZN(SQ_instance_n460) );
  NAND2_X1 SQ_instance_U493 ( .A1(r1p1[2]), .A2(a1p1[1]), .ZN(SQ_instance_n459) );
  NOR2_X1 SQ_instance_U492 ( .A1(SQ_instance_n510), .A2(SQ_instance_n509), 
        .ZN(SQ_instance_n461) );
  OR2_X1 SQ_instance_U491 ( .A1(SQ_instance_n511), .A2(r1p1[1]), .ZN(
        SQ_instance_n509) );
  NAND2_X1 SQ_instance_U490 ( .A1(SQ_instance_n458), .A2(a1p1[0]), .ZN(
        SQ_instance_n511) );
  XNOR2_X1 SQ_instance_U489 ( .A(r1p1[2]), .B(SQ_instance_n457), .ZN(
        SQ_instance_n510) );
  NAND2_X1 SQ_instance_U488 ( .A1(a1p1[1]), .A2(SQ_instance_n469), .ZN(
        SQ_instance_n457) );
  OR2_X1 SQ_instance_U487 ( .A1(SQ_instance_n508), .A2(SQ_instance_n505), .ZN(
        SQ_instance_n464) );
  XOR2_X1 SQ_instance_U486 ( .A(r1p1[3]), .B(SQ_instance_n456), .Z(
        SQ_instance_n505) );
  NOR2_X1 SQ_instance_U485 ( .A1(SQ_instance_n455), .A2(r1p1[2]), .ZN(
        SQ_instance_n508) );
  ...
  XOR2_X1 SQ_instance_U482 ( .A(SQ_instance_n452), .B(SQ_instance_n451), .Z(
        SQ_instance_n453) );
  XOR2_X1 SQ_instance_U481 ( .A(r1p1[4]), .B(SQ_instance_n491), .Z(
        SQ_instance_n471) );
  ...
  OR2_X1 SQ_instance_U478 ( .A1(SQ_instance_n451), .A2(SQ_instance_n452), .ZN(
        SQ_instance_n448) );
  NOR2_X1 SQ_instance_U477 ( .A1(r1p1[3]), .A2(SQ_instance_n456), .ZN(
        SQ_instance_n454) );
  NAND2_X1 SQ_instance_U476 ( .A1(a1p1[0]), .A2(a1p1[2]), .ZN(SQ_instance_n456) );
  ...
  NOR2_X1 SQ_instance_U470 ( .A1(SQ_instance_n455), .A2(SQ_instance_n500), 
        .ZN(SQ_instance_n484) );
  NOR2_X1 SQ_instance_U469 ( .A1(r1p1[4]), .A2(SQ_instance_n491), .ZN(
        SQ_instance_n481) );
  ...
  NOR2_X1 SQ_instance_U221 ( .A1(SQ_instance_n220), .A2(SQ_instance_n223), 
        .ZN(SQ_instance_n192) );
  NAND2_X1 SQ_instance_U220 ( .A1(a0p1[4]), .A2(SQ_instance_n184), .ZN(
        SQ_instance_n223) );
  ...
  AND2_X1 SQ_instance_U176 ( .A1(SQ_instance_n147), .A2(SQ_instance_n146), 
        .ZN(SQ_instance_n132) );
  NAND2_X1 SQ_instance_U175 ( .A1(SQ_instance_n131), .A2(a0p1[4]), .ZN(
        SQ_instance_n146) );
  OR2_X1 SQ_instance_U174 ( .A1(SQ_instance_n130), .A2(SQ_instance_n129), .ZN(
        SQ_instance_n147) );
  NAND2_X1 SQ_instance_U173 ( .A1(a0p1[2]), .A2(SQ_instance_n128), .ZN(
        SQ_instance_n149) );
  ...
  NOR2_X1 SQ_instance_U168 ( .A1(SQ_instance_n145), .A2(SQ_instance_n144), 
        .ZN(SQ_instance_n122) );
  NAND2_X1 SQ_instance_U167 ( .A1(SQ_instance_n121), .A2(a0p1[1]), .ZN(
        SQ_instance_n144) );
  ...
  NOR2_X1 SQ_instance_U161 ( .A1(SQ_instance_n119), .A2(SQ_instance_n118), 
        .ZN(SQ_instance_n123) );
  NAND2_X1 SQ_instance_U160 ( .A1(r1p1[4]), .A2(SQ_instance_n111), .ZN(
        SQ_instance_n119) );
  ...
  OR2_X1 SQ_instance_U153 ( .A1(SQ_instance_n130), .A2(SQ_instance_n106), .ZN(
        SQ_instance_n124) );
  NAND2_X1 SQ_instance_U152 ( .A1(SQ_instance_n128), .A2(a0p1[3]), .ZN(
        SQ_instance_n125) );
  NAND2_X1 SQ_instance_U151 ( .A1(a0p1[2]), .A2(SQ_instance_n184), .ZN(
        SQ_instance_n127) );
  ...
  XNOR2_X1 SQ_instance_U142 ( .A(SQ_instance_n115), .B(SQ_instance_n113), .ZN(
        SQ_instance_n102) );
  NAND2_X1 SQ_instance_U141 ( .A1(a0p1[4]), .A2(SQ_instance_n101), .ZN(
        SQ_instance_n113) );
  NOR2_X1 SQ_instance_U140 ( .A1(SQ_instance_n130), .A2(SQ_instance_n100), 
        .ZN(SQ_instance_n115) );
  AND2_X1 SQ_instance_U139 ( .A1(SQ_instance_n131), .A2(a0p1[3]), .ZN(
        SQ_instance_n114) );
  ...
  XOR2_X1 SQ_instance_U133 ( .A(SQ_instance_n153), .B(SQ_instance_n151), .Z(
        SQ_instance_n93) );
  XNOR2_X1 SQ_instance_U132 ( .A(r1p1[4]), .B(SQ_instance_n111), .ZN(
        SQ_instance_n151) );
  ...
  AND2_X1 SQ_instance_U129 ( .A1(r1p1[3]), .A2(SQ_instance_n92), .ZN(
        SQ_instance_n153) );
  ...
  NOR2_X1 SQ_instance_U116 ( .A1(SQ_instance_n129), .A2(SQ_instance_n76), .ZN(
        SQ_instance_n97) );
  NAND2_X1 SQ_instance_U115 ( .A1(a0p1[0]), .A2(SQ_instance_n128), .ZN(
        SQ_instance_n95) );
  ...
  XNOR2_X1 SQ_instance_U113 ( .A(SQ_instance_n75), .B(SQ_instance_n74), .ZN(
        SQ_instance_n85) );
  XNOR2_X1 SQ_instance_U112 ( .A(SQ_instance_n129), .B(r0p1[3]), .ZN(
        SQ_instance_n74) );
  AND2_X1 SQ_instance_U111 ( .A1(SQ_instance_n73), .A2(SQ_instance_n72), .ZN(
        SQ_instance_n86) );
  AND2_X1 SQ_instance_U110 ( .A1(a0p1[2]), .A2(SQ_instance_n131), .ZN(
        SQ_instance_n96) );
  ...
  AND2_X1 SQ_instance_U103 ( .A1(SQ_instance_n206), .A2(SQ_instance_n209), 
        .ZN(SQ_instance_n66) );
  NAND2_X1 SQ_instance_U102 ( .A1(SQ_instance_n131), .A2(a0p1[0]), .ZN(
        SQ_instance_n209) );
  OR2_X1 SQ_instance_U101 ( .A1(SQ_instance_n458), .A2(SQ_instance_n205), .ZN(
        SQ_instance_n206) );
  NAND2_X1 SQ_instance_U100 ( .A1(a0p1[0]), .A2(SQ_instance_n101), .ZN(
        SQ_instance_n205) );
  INV_X1 SQ_instance_U99 ( .A(r1p1[0]), .ZN(SQ_instance_n458) );
  XOR2_X1 SQ_instance_U98 ( .A(r1p1[1]), .B(SQ_instance_n65), .Z(
        SQ_instance_n207) );
  AND2_X1 SQ_instance_U97 ( .A1(SQ_instance_n198), .A2(SQ_instance_n197), .ZN(
        SQ_instance_n71) );
  XOR2_X1 SQ_instance_U96 ( .A(r1p1[2]), .B(SQ_instance_n64), .Z(
        SQ_instance_n197) );
  ...
  OR2_X1 SQ_instance_U86 ( .A1(SQ_instance_n53), .A2(SQ_instance_n65), .ZN(
        SQ_instance_n60) );
  NAND2_X1 SQ_instance_U85 ( .A1(SQ_instance_n101), .A2(a0p1[1]), .ZN(
        SQ_instance_n65) );
  INV_X1 SQ_instance_U84 ( .A(SQ_instance_n76), .ZN(SQ_instance_n101) );
  INV_X1 SQ_instance_U83 ( .A(r1p1[1]), .ZN(SQ_instance_n53) );
  NAND2_X1 SQ_instance_U82 ( .A1(a0p1[1]), .A2(SQ_instance_n131), .ZN(
        SQ_instance_n61) );
  ...
  OR2_X1 SQ_instance_U79 ( .A1(SQ_instance_n79), .A2(SQ_instance_n78), .ZN(
        SQ_instance_n59) );
  NAND2_X1 SQ_instance_U78 ( .A1(r1p1[2]), .A2(SQ_instance_n64), .ZN(
        SQ_instance_n78) );
  ...
  XOR2_X1 SQ_instance_U76 ( .A(SQ_instance_n50), .B(SQ_instance_n49), .Z(
        SQ_instance_n76) );
  XNOR2_X1 SQ_instance_U75 ( .A(r1p1[3]), .B(SQ_instance_n92), .ZN(
        SQ_instance_n79) );
  ...
  XOR2_X1 SQ_instance_U72 ( .A(SQ_instance_n48), .B(SQ_instance_n47), .Z(
        SQ_instance_n72) );
  XOR2_X1 SQ_instance_U71 ( .A(SQ_instance_n100), .B(r0p1[2]), .Z(
        SQ_instance_n47) );
  ...
  NAND2_X1 SQ_instance_U64 ( .A1(SQ_instance_n75), .A2(SQ_instance_n41), .ZN(
        SQ_instance_n42) );
  NAND2_X1 SQ_instance_U63 ( .A1(SQ_instance_n40), .A2(a0p1[3]), .ZN(
        SQ_instance_n41) );
  ...
  NAND2_X1 SQ_instance_U61 ( .A1(SQ_instance_n48), .A2(SQ_instance_n37), .ZN(
        SQ_instance_n38) );
  NAND2_X1 SQ_instance_U60 ( .A1(SQ_instance_n36), .A2(a0p1[2]), .ZN(
        SQ_instance_n37) );
  ...
  NAND2_X1 SQ_instance_U58 ( .A1(SQ_instance_n33), .A2(SQ_instance_n32), .ZN(
        SQ_instance_n34) );
  NAND2_X1 SQ_instance_U57 ( .A1(SQ_instance_n31), .A2(a0p1[1]), .ZN(
        SQ_instance_n32) );
  NAND2_X1 SQ_instance_U56 ( .A1(r0p1[1]), .A2(SQ_instance_n120), .ZN(
        SQ_instance_n35) );
  NAND2_X1 SQ_instance_U55 ( .A1(r0p1[2]), .A2(SQ_instance_n100), .ZN(
        SQ_instance_n39) );
  INV_X1 SQ_instance_U54 ( .A(a0p1[2]), .ZN(SQ_instance_n100) );
  NAND2_X1 SQ_instance_U53 ( .A1(r0p1[3]), .A2(SQ_instance_n129), .ZN(
        SQ_instance_n43) );
  INV_X1 SQ_instance_U52 ( .A(a0p1[3]), .ZN(SQ_instance_n129) );
  NOR2_X1 SQ_instance_U51 ( .A1(r0p1[4]), .A2(SQ_instance_n106), .ZN(
        SQ_instance_n46) );
  INV_X1 SQ_instance_U50 ( .A(a0p1[4]), .ZN(SQ_instance_n106) );
  XOR2_X1 SQ_instance_U49 ( .A(SQ_instance_n91), .B(r0p1[0]), .Z(
        SQ_instance_n50) );
  XOR2_X1 SQ_instance_U48 ( .A(SQ_instance_n33), .B(SQ_instance_n30), .Z(
        SQ_instance_n52) );
  XNOR2_X1 SQ_instance_U47 ( .A(SQ_instance_n120), .B(r0p1[1]), .ZN(
        SQ_instance_n30) );
  AND2_X1 SQ_instance_U46 ( .A1(r0p1[0]), .A2(SQ_instance_n91), .ZN(
        SQ_instance_n33) );
  INV_X1 SQ_instance_U45 ( .A(a0p1[0]), .ZN(SQ_instance_n91) );
  INV_X1 SQ_instance_U44 ( .A(a0p1[1]), .ZN(SQ_instance_n120) );
  ...
  XOR2_X1 SQ_instance_U40 ( .A(SQ_instance_n25), .B(SQ_instance_n24), .Z(
        SQ_instance_a12r0[3]) );
  XOR2_X1 SQ_instance_U39 ( .A(a1p1[2]), .B(SQ_instance_n23), .Z(
        SQ_instance_n24) );
  ...
  XNOR2_X1 SQ_instance_U34 ( .A(SQ_instance_n17), .B(SQ_instance_n16), .ZN(
        SQ_instance_n21) );
  XOR2_X1 SQ_instance_U33 ( .A(SQ_instance_n36), .B(a1p1[1]), .Z(
        SQ_instance_n16) );
  ...
  XOR2_X1 SQ_instance_U28 ( .A(SQ_instance_n15), .B(SQ_instance_n14), .Z(
        SQ_instance_a12r0[0]) );
  XOR2_X1 SQ_instance_U27 ( .A(r0p1[0]), .B(SQ_instance_n497), .Z(
        SQ_instance_n14) );
  INV_X1 SQ_instance_U26 ( .A(a1p1[4]), .ZN(SQ_instance_n497) );
  ...
  NOR2_X1 SQ_instance_U22 ( .A1(SQ_instance_n40), .A2(SQ_instance_n491), .ZN(
        SQ_instance_n8) );
  INV_X1 SQ_instance_U21 ( .A(a1p1[2]), .ZN(SQ_instance_n491) );
  INV_X1 SQ_instance_U20 ( .A(r0p1[3]), .ZN(SQ_instance_n40) );
  ...
  NOR2_X1 SQ_instance_U13 ( .A1(SQ_instance_n31), .A2(SQ_instance_n469), .ZN(
        SQ_instance_n2) );
  INV_X1 SQ_instance_U12 ( .A(a1p1[0]), .ZN(SQ_instance_n469) );
  ...
  NOR2_X1 SQ_instance_U7 ( .A1(SQ_instance_n36), .A2(SQ_instance_n455), .ZN(
        SQ_instance_n6) );
  INV_X1 SQ_instance_U6 ( .A(a1p1[1]), .ZN(SQ_instance_n455) );
  INV_X1 SQ_instance_U5 ( .A(r0p1[2]), .ZN(SQ_instance_n36) );
  XOR2_X1 SQ_instance_U4 ( .A(SQ_instance_n44), .B(a1p1[3]), .Z(
        SQ_instance_n29) );
  NOR2_X1 SQ_instance_U3 ( .A1(SQ_instance_n44), .A2(SQ_instance_n500), .ZN(
        SQ_instance_n11) );
  INV_X1 SQ_instance_U2 ( .A(a1p1[3]), .ZN(SQ_instance_n500) );
  INV_X1 SQ_instance_U1 ( .A(r0p1[4]), .ZN(SQ_instance_n44) );
