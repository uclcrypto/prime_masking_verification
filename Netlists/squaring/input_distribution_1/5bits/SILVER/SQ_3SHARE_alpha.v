...
(* SILVER="clock" *)  input clk;
  ...
  OR2_X1 U46 ( .A1(a0_mod_r[1]), .A2(n28), .ZN(a0_sel_r[1]) );
  OR2_X1 U47 ( .A1(a1_mod_r[2]), .A2(n28), .ZN(a1_sel_r[2]) );
  OR2_X1 U48 ( .A1(a0_mod_r[2]), .A2(n28), .ZN(a0_sel_r[2]) );
  OR2_X1 U49 ( .A1(a1_mod_r[4]), .A2(n28), .ZN(a1_sel_r[4]) );
  OR2_X1 U50 ( .A1(a2_mod_r[1]), .A2(n28), .ZN(a2_sel_r[1]) );
  OR2_X1 U51 ( .A1(a2_mod_r[2]), .A2(n28), .ZN(a2_sel_r[2]) );
  OR2_X1 U52 ( .A1(a0_mod_r[4]), .A2(n28), .ZN(a0_sel_r[4]) );
  OR2_X1 U53 ( .A1(a0_mod_r[3]), .A2(n28), .ZN(a0_sel_r[3]) );
  OR2_X1 U54 ( .A1(a2_mod_r[4]), .A2(n28), .ZN(a2_sel_r[4]) );
  OR2_X1 U55 ( .A1(a1_mod_r[3]), .A2(n28), .ZN(a1_sel_r[3]) );
  OR2_X1 U56 ( .A1(a0_mod_r[0]), .A2(n28), .ZN(a0_sel_r[0]) );
  OR2_X1 U57 ( .A1(a1_mod_r[1]), .A2(n28), .ZN(a1_sel_r[1]) );
  OR2_X1 U58 ( .A1(a2_mod_r[0]), .A2(n28), .ZN(a2_sel_r[0]) );
  OR2_X1 U59 ( .A1(a1_mod_r[0]), .A2(n28), .ZN(a1_sel_r[0]) );
  OR2_X1 U60 ( .A1(a2_mod_r[3]), .A2(n28), .ZN(a2_sel_r[3]) );
  ...
  OR2_X1 RED1_U9 ( .A1(a0_r[3]), .A2(RED1_n4), .ZN(a0_mod_r[3]) );
  OR2_X1 RED1_U8 ( .A1(a0_r[4]), .A2(RED1_n4), .ZN(a0_mod_r[4]) );
  ...
  OR2_X1 RED3_U9 ( .A1(a2_r[3]), .A2(RED3_n4), .ZN(a2_mod_r[3]) );
  OR2_X1 RED3_U8 ( .A1(a2_r[4]), .A2(RED3_n4), .ZN(a2_mod_r[4]) );
