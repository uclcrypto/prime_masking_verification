module SQ_2SHARE_PROLEADWRAP ( clk, a0, a1, r0, r1, b0, b1 );
  ...
  output [1:0] b1;
  input clk;
  wire   net4289, net4290, net4291, net4292, net4293, net4294, net4295,
         net4296, net4297, net4298, net4299, net4300, Add1_n3, Add2_n3,
         Add3_n3, Add4_n3, Sub1_n3, Sub2_n3, SQ_instance_n96, SQ_instance_n95,
  ...
  NOR2_X1 Add1_U4 ( .A1(a0[1]), .A2(Add1_n3), .ZN(a0p1[1]) );
  INV_X1 Add1_U3 ( .A(a0[0]), .ZN(Add1_n3) );
  XNOR2_X1 Add1_U2 ( .A(a0[1]), .B(a0[0]), .ZN(a0p1[0]) );
  NOR2_X1 Add2_U4 ( .A1(a1[1]), .A2(Add2_n3), .ZN(a1p1[1]) );
  INV_X1 Add2_U3 ( .A(a1[0]), .ZN(Add2_n3) );
  XNOR2_X1 Add2_U2 ( .A(a1[1]), .B(a1[0]), .ZN(a1p1[0]) );
  NOR2_X1 Add3_U4 ( .A1(r0[1]), .A2(Add3_n3), .ZN(r0p1[1]) );
  INV_X1 Add3_U3 ( .A(r0[0]), .ZN(Add3_n3) );
  XNOR2_X1 Add3_U2 ( .A(r0[1]), .B(r0[0]), .ZN(r0p1[0]) );
  NOR2_X1 Add4_U4 ( .A1(r1[1]), .A2(Add4_n3), .ZN(r1p1[1]) );
  INV_X1 Add4_U3 ( .A(r1[0]), .ZN(Add4_n3) );
  XNOR2_X1 Add4_U2 ( .A(r1[1]), .B(r1[0]), .ZN(r1p1[0]) );
  ...
  NOR2_X1 SQ_instance_U98 ( .A1(SQ_instance_n84), .A2(SQ_instance_n2), .ZN(
        SQ_instance_a1sr1[1]) );
  XNOR2_X1 SQ_instance_U97 ( .A(SQ_instance_n81), .B(r1p1[1]), .ZN(
        SQ_instance_n83) );
  XOR2_X1 SQ_instance_U96 ( .A(SQ_instance_n4), .B(SQ_instance_n3), .Z(
        SQ_instance_n84) );
  NAND2_X1 SQ_instance_U95 ( .A1(a1p1[0]), .A2(a1p1[1]), .ZN(SQ_instance_n81)
         );
  NOR2_X1 SQ_instance_U94 ( .A1(a1p1[0]), .A2(a1p1[1]), .ZN(SQ_instance_n80)
         );
  ...
  XNOR2_X1 SQ_instance_U92 ( .A(SQ_instance_n77), .B(SQ_instance_n76), .ZN(
        SQ_instance_n78) );
  AND2_X1 SQ_instance_U91 ( .A1(SQ_instance_n75), .A2(r1p1[1]), .ZN(
        SQ_instance_n77) );
  NOR2_X1 SQ_instance_U90 ( .A1(r1p1[1]), .A2(SQ_instance_n75), .ZN(
        SQ_instance_n79) );
  XNOR2_X1 SQ_instance_U89 ( .A(SQ_instance_n82), .B(a1p1[1]), .ZN(
        SQ_instance_n75) );
  ...
  NAND2_X1 SQ_instance_U51 ( .A1(SQ_instance_n39), .A2(SQ_instance_n38), .ZN(
        SQ_instance_n40) );
  NAND2_X1 SQ_instance_U50 ( .A1(r0p1[0]), .A2(a1p1[1]), .ZN(SQ_instance_n39)
         );
  NOR2_X1 SQ_instance_U49 ( .A1(SQ_instance_n45), .A2(SQ_instance_n44), .ZN(
        SQ_instance_n41) );
  XNOR2_X1 SQ_instance_U48 ( .A(r0p1[0]), .B(a1p1[1]), .ZN(SQ_instance_n44) );
  ...
  NOR2_X1 SQ_instance_U46 ( .A1(SQ_instance_n36), .A2(SQ_instance_n82), .ZN(
        SQ_instance_n37) );
  INV_X1 SQ_instance_U45 ( .A(a1p1[0]), .ZN(SQ_instance_n82) );
  NOR2_X1 SQ_instance_U44 ( .A1(SQ_instance_n35), .A2(SQ_instance_n38), .ZN(
        SQ_instance_n43) );
  XNOR2_X1 SQ_instance_U43 ( .A(r0p1[1]), .B(a1p1[0]), .ZN(SQ_instance_n38) );
  ...
  NOR2_X1 SQ_instance_U36 ( .A1(SQ_instance_n34), .A2(SQ_instance_n33), .ZN(
        SQ_instance_n92) );
  XOR2_X1 SQ_instance_U35 ( .A(r1p1[0]), .B(SQ_instance_n28), .Z(
        SQ_instance_n33) );
  ...
  NAND2_X1 SQ_instance_U33 ( .A1(SQ_instance_n25), .A2(SQ_instance_n24), .ZN(
        SQ_instance_n26) );
  NAND2_X1 SQ_instance_U32 ( .A1(r1p1[1]), .A2(SQ_instance_n23), .ZN(
        SQ_instance_n24) );
  ...
  NOR2_X1 SQ_instance_U29 ( .A1(SQ_instance_n18), .A2(SQ_instance_n17), .ZN(
        SQ_instance_n19) );
  NOR2_X1 SQ_instance_U28 ( .A1(r0p1[1]), .A2(SQ_instance_n16), .ZN(
        SQ_instance_n17) );
  ...
  XNOR2_X1 SQ_instance_U26 ( .A(SQ_instance_n22), .B(SQ_instance_n15), .ZN(
        SQ_instance_n31) );
  XOR2_X1 SQ_instance_U25 ( .A(r1p1[1]), .B(SQ_instance_n21), .Z(
        SQ_instance_n15) );
  NAND2_X1 SQ_instance_U24 ( .A1(a0p1[1]), .A2(SQ_instance_n14), .ZN(
        SQ_instance_n21) );
  ...
  NOR2_X1 SQ_instance_U22 ( .A1(SQ_instance_n12), .A2(SQ_instance_n11), .ZN(
        SQ_instance_n20) );
  NOR2_X1 SQ_instance_U21 ( .A1(r0p1[1]), .A2(SQ_instance_n10), .ZN(
        SQ_instance_n11) );
  ...
  OR2_X1 SQ_instance_U18 ( .A1(SQ_instance_n28), .A2(SQ_instance_n76), .ZN(
        SQ_instance_n29) );
  INV_X1 SQ_instance_U17 ( .A(r1p1[0]), .ZN(SQ_instance_n76) );
  NAND2_X1 SQ_instance_U16 ( .A1(SQ_instance_n14), .A2(a0p1[0]), .ZN(
        SQ_instance_n28) );
  XNOR2_X1 SQ_instance_U15 ( .A(SQ_instance_n7), .B(SQ_instance_n6), .ZN(
        SQ_instance_n14) );
  NAND2_X1 SQ_instance_U14 ( .A1(r0p1[1]), .A2(SQ_instance_n9), .ZN(
        SQ_instance_n6) );
  ...
  NOR2_X1 SQ_instance_U12 ( .A1(SQ_instance_n36), .A2(SQ_instance_n18), .ZN(
        SQ_instance_n5) );
  INV_X1 SQ_instance_U11 ( .A(a0p1[1]), .ZN(SQ_instance_n18) );
  INV_X1 SQ_instance_U10 ( .A(r0p1[1]), .ZN(SQ_instance_n36) );
  NAND2_X1 SQ_instance_U9 ( .A1(SQ_instance_n8), .A2(SQ_instance_n16), .ZN(
        SQ_instance_n7) );
  NAND2_X1 SQ_instance_U8 ( .A1(r0p1[0]), .A2(SQ_instance_n10), .ZN(
        SQ_instance_n16) );
  INV_X1 SQ_instance_U7 ( .A(a0p1[0]), .ZN(SQ_instance_n10) );
  NAND2_X1 SQ_instance_U6 ( .A1(a0p1[0]), .A2(SQ_instance_n35), .ZN(
        SQ_instance_n8) );
  INV_X1 SQ_instance_U5 ( .A(r0p1[0]), .ZN(SQ_instance_n35) );
  XNOR2_X1 SQ_instance_U4 ( .A(r1p1[0]), .B(SQ_instance_n80), .ZN(
        SQ_instance_n4) );
  OR2_X1 SQ_instance_U3 ( .A1(SQ_instance_n81), .A2(r1p1[1]), .ZN(
        SQ_instance_n3) );
  XNOR2_X1 SQ_instance_U2 ( .A(SQ_instance_n83), .B(SQ_instance_n1), .ZN(
        SQ_instance_n2) );
  AND2_X1 SQ_instance_U1 ( .A1(r1p1[0]), .A2(SQ_instance_n82), .ZN(
        SQ_instance_n1) );
