...
(* SILVER="clock" *)  input clk;
  wire   r0_p_r, r1_p_r, r2_p_r, r3_p_r, r4_p_r, r5_p_r, r6_p_r, r7_p_r,
         ...
         n33, n34, RED1_n1, RED2_n1, RED3_n1, RED4_n1, SQ_instance_n541,
  ...
  OR2_X1 U45 ( .A1(a0_mod_r[0]), .A2(n34), .ZN(a0_sel_r[0]) );
  OR2_X1 U46 ( .A1(a0_mod_r[1]), .A2(n34), .ZN(a0_sel_r[1]) );
  OR2_X1 U47 ( .A1(a1_mod_r[1]), .A2(n34), .ZN(a1_sel_r[1]) );
  OR2_X1 U48 ( .A1(a1_mod_r[0]), .A2(n34), .ZN(a1_sel_r[0]) );
  OR2_X1 U49 ( .A1(a3_mod_r[1]), .A2(n34), .ZN(a3_sel_r[1]) );
  OR2_X1 U50 ( .A1(a2_mod_r[1]), .A2(n34), .ZN(a2_sel_r[1]) );
