...
module SQ_2SHARE_PROLEADWRAP ( clk, a0, a1, r0, r1, b0, b1 );
  ...
  output [2:0] b1;
  input clk;
  wire   net7659, net7660, net7661, net7662, net7663, net7664, net7665,
         net7666, net7667, net7668, net7669, net7670, net7671, net7672,
         net7673, net7674, net7675, net7676, Add1_n11, Add1_n10, Add1_n9,
         ...
         Add4_n4, Sub1_n5, Sub1_n4, Sub2_n5, Sub2_n4, SQ_instance_n240,
  ...
  NAND2_X1 Add3_U12 ( .A1(Add3_n11), .A2(Add3_n10), .ZN(r0p1[2]) );
  NAND2_X1 Add3_U11 ( .A1(Add3_n9), .A2(r0[0]), .ZN(Add3_n10) );
  NAND2_X1 Add3_U10 ( .A1(r0[2]), .A2(Add3_n8), .ZN(Add3_n11) );
  NAND2_X1 Add3_U9 ( .A1(Add3_n7), .A2(Add3_n6), .ZN(r0p1[1]) );
  NAND2_X1 Add3_U8 ( .A1(r0[0]), .A2(Add3_n8), .ZN(Add3_n6) );
  NAND2_X1 Add3_U7 ( .A1(Add3_n9), .A2(Add3_n5), .ZN(Add3_n7) );
  NOR2_X1 Add3_U6 ( .A1(r0[2]), .A2(Add3_n8), .ZN(Add3_n9) );
  INV_X1 Add3_U5 ( .A(r0[1]), .ZN(Add3_n8) );
  XNOR2_X1 Add3_U4 ( .A(Add3_n5), .B(Add3_n4), .ZN(r0p1[0]) );
  NAND2_X1 Add3_U3 ( .A1(r0[2]), .A2(r0[1]), .ZN(Add3_n4) );
  INV_X1 Add3_U2 ( .A(r0[0]), .ZN(Add3_n5) );
  NAND2_X1 Add4_U12 ( .A1(Add4_n11), .A2(Add4_n10), .ZN(r1p1[2]) );
  NAND2_X1 Add4_U11 ( .A1(Add4_n9), .A2(r1[0]), .ZN(Add4_n10) );
  NAND2_X1 Add4_U10 ( .A1(r1[2]), .A2(Add4_n8), .ZN(Add4_n11) );
  NAND2_X1 Add4_U9 ( .A1(Add4_n7), .A2(Add4_n6), .ZN(r1p1[1]) );
  NAND2_X1 Add4_U8 ( .A1(r1[0]), .A2(Add4_n8), .ZN(Add4_n6) );
  NAND2_X1 Add4_U7 ( .A1(Add4_n9), .A2(Add4_n5), .ZN(Add4_n7) );
  NOR2_X1 Add4_U6 ( .A1(r1[2]), .A2(Add4_n8), .ZN(Add4_n9) );
  INV_X1 Add4_U5 ( .A(r1[1]), .ZN(Add4_n8) );
  XNOR2_X1 Add4_U4 ( .A(Add4_n5), .B(Add4_n4), .ZN(r1p1[0]) );
  NAND2_X1 Add4_U3 ( .A1(r1[2]), .A2(r1[1]), .ZN(Add4_n4) );
  INV_X1 Add4_U2 ( .A(r1[0]), .ZN(Add4_n5) );
  ...
  XOR2_X1 SQ_instance_U242 ( .A(SQ_instance_n227), .B(SQ_instance_n226), .Z(
        SQ_instance_n237) );
  XOR2_X1 SQ_instance_U241 ( .A(SQ_instance_n225), .B(a1p1[0]), .Z(
        SQ_instance_n226) );
  ...
  NOR2_X1 SQ_instance_U234 ( .A1(SQ_instance_n218), .A2(SQ_instance_n217), 
        .ZN(SQ_instance_n227) );
  NAND2_X1 SQ_instance_U233 ( .A1(r0p1[1]), .A2(a1p1[0]), .ZN(SQ_instance_n222) );
  XOR2_X1 SQ_instance_U232 ( .A(r0p1[2]), .B(a1p1[1]), .Z(SQ_instance_n232) );
  NAND2_X1 SQ_instance_U231 ( .A1(r0p1[2]), .A2(a1p1[1]), .ZN(SQ_instance_n224) );
  ...
  NAND2_X1 SQ_instance_U205 ( .A1(SQ_instance_n198), .A2(SQ_instance_n197), 
        .ZN(SQ_instance_n199) );
  XOR2_X1 SQ_instance_U204 ( .A(r1p1[0]), .B(SQ_instance_n185), .Z(
        SQ_instance_n197) );
  ...
  NOR2_X1 SQ_instance_U198 ( .A1(SQ_instance_n180), .A2(SQ_instance_n179), 
        .ZN(SQ_instance_n177) );
  NAND2_X1 SQ_instance_U197 ( .A1(SQ_instance_n176), .A2(a0p1[2]), .ZN(
        SQ_instance_n179) );
  ...
  NOR2_X1 SQ_instance_U176 ( .A1(SQ_instance_n148), .A2(SQ_instance_n147), 
        .ZN(SQ_instance_n171) );
  NAND2_X1 SQ_instance_U175 ( .A1(a0p1[1]), .A2(SQ_instance_n146), .ZN(
        SQ_instance_n160) );
  ...
  XOR2_X1 SQ_instance_U170 ( .A(SQ_instance_n147), .B(SQ_instance_n148), .Z(
        SQ_instance_n154) );
  NAND2_X1 SQ_instance_U169 ( .A1(a0p1[2]), .A2(SQ_instance_n144), .ZN(
        SQ_instance_n148) );
  ...
  AND2_X1 SQ_instance_U165 ( .A1(SQ_instance_n186), .A2(SQ_instance_n189), 
        .ZN(SQ_instance_n141) );
  NAND2_X1 SQ_instance_U164 ( .A1(SQ_instance_n185), .A2(r1p1[0]), .ZN(
        SQ_instance_n189) );
  AND2_X1 SQ_instance_U163 ( .A1(a0p1[0]), .A2(SQ_instance_n144), .ZN(
        SQ_instance_n185) );
  OR2_X1 SQ_instance_U162 ( .A1(SQ_instance_n149), .A2(SQ_instance_n140), .ZN(
        SQ_instance_n186) );
  XOR2_X1 SQ_instance_U161 ( .A(r1p1[1]), .B(SQ_instance_n139), .Z(
        SQ_instance_n187) );
  ...
  NAND2_X1 SQ_instance_U154 ( .A1(SQ_instance_n133), .A2(SQ_instance_n132), 
        .ZN(SQ_instance_n135) );
  INV_X1 SQ_instance_U153 ( .A(a0p1[0]), .ZN(SQ_instance_n140) );
  NOR2_X1 SQ_instance_U152 ( .A1(SQ_instance_n139), .A2(SQ_instance_n131), 
        .ZN(SQ_instance_n161) );
  NAND2_X1 SQ_instance_U151 ( .A1(a0p1[1]), .A2(SQ_instance_n144), .ZN(
        SQ_instance_n139) );
  ...
  XOR2_X1 SQ_instance_U147 ( .A(SQ_instance_n127), .B(SQ_instance_n126), .Z(
        SQ_instance_n132) );
  XOR2_X1 SQ_instance_U146 ( .A(a0p1[1]), .B(SQ_instance_n225), .Z(
        SQ_instance_n126) );
  ...
  AND2_X1 SQ_instance_U143 ( .A1(SQ_instance_n134), .A2(SQ_instance_n137), 
        .ZN(SQ_instance_n124) );
  XOR2_X1 SQ_instance_U142 ( .A(r0p1[2]), .B(SQ_instance_n175), .Z(
        SQ_instance_n137) );
  ...
  NAND2_X1 SQ_instance_U140 ( .A1(SQ_instance_n127), .A2(SQ_instance_n121), 
        .ZN(SQ_instance_n122) );
  NAND2_X1 SQ_instance_U139 ( .A1(SQ_instance_n225), .A2(a0p1[1]), .ZN(
        SQ_instance_n121) );
  INV_X1 SQ_instance_U138 ( .A(r0p1[1]), .ZN(SQ_instance_n225) );
  NOR2_X1 SQ_instance_U137 ( .A1(a0p1[0]), .A2(SQ_instance_n218), .ZN(
        SQ_instance_n127) );
  NAND2_X1 SQ_instance_U136 ( .A1(r0p1[1]), .A2(SQ_instance_n128), .ZN(
        SQ_instance_n123) );
  NOR2_X1 SQ_instance_U135 ( .A1(r0p1[2]), .A2(SQ_instance_n175), .ZN(
        SQ_instance_n125) );
  INV_X1 SQ_instance_U134 ( .A(a0p1[2]), .ZN(SQ_instance_n175) );
  XOR2_X1 SQ_instance_U133 ( .A(SQ_instance_n218), .B(a0p1[0]), .Z(
        SQ_instance_n130) );
  INV_X1 SQ_instance_U132 ( .A(r0p1[0]), .ZN(SQ_instance_n218) );
  INV_X1 SQ_instance_U131 ( .A(a0p1[1]), .ZN(SQ_instance_n128) );
  ...
  XOR2_X1 SQ_instance_U34 ( .A(SQ_instance_n23), .B(SQ_instance_n22), .Z(
        SQ_instance_n29) );
  NAND2_X1 SQ_instance_U33 ( .A1(a1p1[2]), .A2(SQ_instance_n21), .ZN(
        SQ_instance_n22) );
  ...
  NOR2_X1 SQ_instance_U23 ( .A1(SQ_instance_n217), .A2(SQ_instance_n9), .ZN(
        SQ_instance_n11) );
  NOR2_X1 SQ_instance_U22 ( .A1(a1p1[1]), .A2(SQ_instance_n8), .ZN(
        SQ_instance_n9) );
  ...
  XOR2_X1 SQ_instance_U19 ( .A(SQ_instance_n13), .B(SQ_instance_n12), .Z(
        SQ_instance_n34) );
  XOR2_X1 SQ_instance_U18 ( .A(r1p1[0]), .B(a1p1[0]), .Z(SQ_instance_n12) );
  ...
  NOR2_X1 SQ_instance_U15 ( .A1(SQ_instance_n219), .A2(SQ_instance_n217), .ZN(
        SQ_instance_n15) );
  INV_X1 SQ_instance_U14 ( .A(a1p1[2]), .ZN(SQ_instance_n217) );
  ...
  NOR2_X1 SQ_instance_U12 ( .A1(SQ_instance_n147), .A2(SQ_instance_n2), .ZN(
        SQ_instance_n3) );
  NAND2_X1 SQ_instance_U11 ( .A1(a1p1[1]), .A2(a1p1[0]), .ZN(SQ_instance_n2)
         );
  ...
  NAND2_X1 SQ_instance_U9 ( .A1(SQ_instance_n14), .A2(SQ_instance_n131), .ZN(
        SQ_instance_n6) );
  INV_X1 SQ_instance_U8 ( .A(r1p1[1]), .ZN(SQ_instance_n131) );
  NOR2_X1 SQ_instance_U7 ( .A1(r1p1[0]), .A2(SQ_instance_n219), .ZN(
        SQ_instance_n14) );
  XOR2_X1 SQ_instance_U6 ( .A(SQ_instance_n147), .B(SQ_instance_n1), .Z(
        SQ_instance_n7) );
  NAND2_X1 SQ_instance_U5 ( .A1(SQ_instance_n219), .A2(a1p1[1]), .ZN(
        SQ_instance_n1) );
  INV_X1 SQ_instance_U4 ( .A(a1p1[0]), .ZN(SQ_instance_n219) );
  INV_X1 SQ_instance_U3 ( .A(r1p1[2]), .ZN(SQ_instance_n147) );
  NOR2_X1 SQ_instance_U2 ( .A1(SQ_instance_n21), .A2(r1p1[2]), .ZN(
        SQ_instance_n16) );
  INV_X1 SQ_instance_U1 ( .A(a1p1[1]), .ZN(SQ_instance_n21) );
