...
module SQ_3SHARE_PROLEADWRAP ( clk, a0, a1, a2, r0, r1, r2, r3, r4, b0, b1, b2
  ...
  output [2:0] b2;
  input clk;
  wire   net17920, net17921, net17922, net17923, net17924, net17925, net17926,
         net17927, net17928, net17929, net17930, net17931, net17932, net17933,
         net17934, net17935, net17936, net17937, net17938, net17939, net17940,
         net17941, net17942, net17943, net17944, net17945, net17946, net17947,
         net17948, net17949, net17950, net17951, net17952, Add1_n5, Add1_n4,
         Add2_n5, Add2_n4, Add3_n5, Add3_n4, Add4_n5, Add4_n4, Add5_n5,
         Add5_n4, Add6_n5, Add6_n4, Add7_n5, Add7_n4, Add8_n5, Add8_n4,
         Sub1_n4, Sub1_n3, Sub1_n2, Sub1_n1, Sub2_n4, Sub2_n3, Sub2_n2,
         Sub2_n1, Sub3_n4, Sub3_n3, Sub3_n2, Sub3_n1, SQ_instance_n540,
  ...
  XOR2_X1 SQ_instance_U547 ( .A(SQ_instance_n517), .B(SQ_instance_n516), .Z(
        SQ_instance_n522) );
  XNOR2_X1 SQ_instance_U546 ( .A(a1p1[0]), .B(r0p1[1]), .ZN(SQ_instance_n516)
         );
  ...
  NAND2_X1 SQ_instance_U543 ( .A1(SQ_instance_n520), .A2(SQ_instance_n519), 
        .ZN(SQ_instance_n514) );
  XNOR2_X1 SQ_instance_U542 ( .A(r0p1[2]), .B(SQ_instance_n513), .ZN(
        SQ_instance_n520) );
  NAND2_X1 SQ_instance_U541 ( .A1(a1p1[1]), .A2(r0p1[2]), .ZN(SQ_instance_n515) );
  XNOR2_X1 SQ_instance_U540 ( .A(a1p1[2]), .B(SQ_instance_n512), .ZN(
        SQ_instance_n525) );
  ...
  NOR2_X1 SQ_instance_U536 ( .A1(SQ_instance_n506), .A2(SQ_instance_n512), 
        .ZN(SQ_instance_n517) );
  NAND2_X1 SQ_instance_U535 ( .A1(a1p1[0]), .A2(r0p1[1]), .ZN(SQ_instance_n511) );
  ...
  XOR2_X1 SQ_instance_U529 ( .A(SQ_instance_n497), .B(SQ_instance_n496), .Z(
        SQ_instance_n502) );
  XNOR2_X1 SQ_instance_U528 ( .A(a2p1[0]), .B(r1p1[1]), .ZN(SQ_instance_n496)
         );
  ...
  NAND2_X1 SQ_instance_U525 ( .A1(SQ_instance_n500), .A2(SQ_instance_n499), 
        .ZN(SQ_instance_n494) );
  XOR2_X1 SQ_instance_U524 ( .A(r1p1[2]), .B(a2p1[1]), .Z(SQ_instance_n500) );
  NAND2_X1 SQ_instance_U523 ( .A1(a2p1[1]), .A2(r1p1[2]), .ZN(SQ_instance_n495) );
  XNOR2_X1 SQ_instance_U522 ( .A(a2p1[2]), .B(SQ_instance_n493), .ZN(
        SQ_instance_n505) );
  ...
  NOR2_X1 SQ_instance_U518 ( .A1(SQ_instance_n487), .A2(SQ_instance_n493), 
        .ZN(SQ_instance_n497) );
  NAND2_X1 SQ_instance_U517 ( .A1(a2p1[0]), .A2(r1p1[1]), .ZN(SQ_instance_n492) );
  ...
  XNOR2_X1 SQ_instance_U511 ( .A(SQ_instance_n478), .B(SQ_instance_n477), .ZN(
        SQ_instance_n483) );
  XNOR2_X1 SQ_instance_U510 ( .A(r2p1[1]), .B(SQ_instance_n476), .ZN(
        SQ_instance_n477) );
  NOR2_X1 SQ_instance_U509 ( .A1(SQ_instance_n486), .A2(SQ_instance_n485), 
        .ZN(SQ_instance_n484) );
  XNOR2_X1 SQ_instance_U508 ( .A(r2p1[0]), .B(a0p1[2]), .ZN(SQ_instance_n485)
         );
  ...
  NOR2_X1 SQ_instance_U503 ( .A1(SQ_instance_n478), .A2(SQ_instance_n470), 
        .ZN(SQ_instance_n473) );
  NOR2_X1 SQ_instance_U502 ( .A1(r2p1[1]), .A2(a0p1[0]), .ZN(SQ_instance_n470)
         );
  NAND2_X1 SQ_instance_U501 ( .A1(r2p1[0]), .A2(a0p1[2]), .ZN(SQ_instance_n478) );
  NOR2_X1 SQ_instance_U500 ( .A1(SQ_instance_n469), .A2(SQ_instance_n468), 
        .ZN(SQ_instance_n475) );
  XNOR2_X1 SQ_instance_U499 ( .A(r2p1[2]), .B(a0p1[1]), .ZN(SQ_instance_n482)
         );
  ...
  NOR2_X1 SQ_instance_U473 ( .A1(SQ_instance_n439), .A2(SQ_instance_n438), 
        .ZN(SQ_instance_n434) );
  NAND2_X1 SQ_instance_U472 ( .A1(SQ_instance_n433), .A2(a0p1[2]), .ZN(
        SQ_instance_n438) );
  ...
  AND2_X1 SQ_instance_U451 ( .A1(SQ_instance_n416), .A2(SQ_instance_n418), 
        .ZN(SQ_instance_n405) );
  NAND2_X1 SQ_instance_U450 ( .A1(a0p1[1]), .A2(SQ_instance_n431), .ZN(
        SQ_instance_n415) );
  NOR2_X1 SQ_instance_U449 ( .A1(SQ_instance_n416), .A2(SQ_instance_n418), 
        .ZN(SQ_instance_n407) );
  NAND2_X1 SQ_instance_U448 ( .A1(a0p1[2]), .A2(SQ_instance_n404), .ZN(
        SQ_instance_n418) );
  ...
  NAND2_X1 SQ_instance_U437 ( .A1(SQ_instance_n394), .A2(SQ_instance_r3_rr[1]), 
        .ZN(SQ_instance_n419) );
  NAND2_X1 SQ_instance_U436 ( .A1(a0p1[1]), .A2(SQ_instance_n404), .ZN(
        SQ_instance_n420) );
  ...
  NOR2_X1 SQ_instance_U430 ( .A1(SQ_instance_n440), .A2(SQ_instance_n443), 
        .ZN(SQ_instance_n393) );
  NAND2_X1 SQ_instance_U429 ( .A1(a0p1[0]), .A2(SQ_instance_n404), .ZN(
        SQ_instance_n443) );
  ...
  XOR2_X1 SQ_instance_U427 ( .A(SQ_instance_n389), .B(SQ_instance_n388), .Z(
        SQ_instance_n396) );
  XNOR2_X1 SQ_instance_U426 ( .A(a0p1[1]), .B(r0p1[1]), .ZN(SQ_instance_n388)
         );
  ...
  XNOR2_X1 SQ_instance_U420 ( .A(SQ_instance_n386), .B(SQ_instance_n387), .ZN(
        SQ_instance_n390) );
  XOR2_X1 SQ_instance_U419 ( .A(r0p1[0]), .B(SQ_instance_n476), .Z(
        SQ_instance_n387) );
  INV_X1 SQ_instance_U418 ( .A(a0p1[0]), .ZN(SQ_instance_n476) );
  ...
  AND2_X1 SQ_instance_U416 ( .A1(SQ_instance_n397), .A2(SQ_instance_n399), 
        .ZN(SQ_instance_n384) );
  XNOR2_X1 SQ_instance_U415 ( .A(r0p1[2]), .B(a0p1[2]), .ZN(SQ_instance_n399)
         );
  ...
  NAND2_X1 SQ_instance_U413 ( .A1(SQ_instance_n389), .A2(SQ_instance_n381), 
        .ZN(SQ_instance_n382) );
  NAND2_X1 SQ_instance_U412 ( .A1(SQ_instance_n508), .A2(a0p1[1]), .ZN(
        SQ_instance_n381) );
  INV_X1 SQ_instance_U411 ( .A(r0p1[1]), .ZN(SQ_instance_n508) );
  NAND2_X1 SQ_instance_U410 ( .A1(a0p1[0]), .A2(SQ_instance_n512), .ZN(
        SQ_instance_n389) );
  INV_X1 SQ_instance_U409 ( .A(r0p1[0]), .ZN(SQ_instance_n512) );
  NAND2_X1 SQ_instance_U408 ( .A1(r0p1[1]), .A2(SQ_instance_n468), .ZN(
        SQ_instance_n383) );
  INV_X1 SQ_instance_U407 ( .A(a0p1[1]), .ZN(SQ_instance_n468) );
  NOR2_X1 SQ_instance_U406 ( .A1(r0p1[2]), .A2(SQ_instance_n432), .ZN(
        SQ_instance_n385) );
  INV_X1 SQ_instance_U405 ( .A(a0p1[2]), .ZN(SQ_instance_n432) );
  ...
  NOR2_X1 SQ_instance_U379 ( .A1(SQ_instance_n352), .A2(SQ_instance_n351), 
        .ZN(SQ_instance_n347) );
  NAND2_X1 SQ_instance_U378 ( .A1(SQ_instance_n346), .A2(a1p1[2]), .ZN(
        SQ_instance_n351) );
  ...
  AND2_X1 SQ_instance_U357 ( .A1(SQ_instance_n330), .A2(SQ_instance_n332), 
        .ZN(SQ_instance_n319) );
  NAND2_X1 SQ_instance_U356 ( .A1(a1p1[1]), .A2(SQ_instance_n345), .ZN(
        SQ_instance_n329) );
  NOR2_X1 SQ_instance_U355 ( .A1(SQ_instance_n330), .A2(SQ_instance_n332), 
        .ZN(SQ_instance_n321) );
  NAND2_X1 SQ_instance_U354 ( .A1(a1p1[2]), .A2(SQ_instance_n318), .ZN(
        SQ_instance_n332) );
  ...
  NAND2_X1 SQ_instance_U343 ( .A1(SQ_instance_n308), .A2(SQ_instance_r4_rr[1]), 
        .ZN(SQ_instance_n333) );
  NAND2_X1 SQ_instance_U342 ( .A1(a1p1[1]), .A2(SQ_instance_n318), .ZN(
        SQ_instance_n334) );
  ...
  NOR2_X1 SQ_instance_U336 ( .A1(SQ_instance_n353), .A2(SQ_instance_n356), 
        .ZN(SQ_instance_n307) );
  NAND2_X1 SQ_instance_U335 ( .A1(a1p1[0]), .A2(SQ_instance_n318), .ZN(
        SQ_instance_n356) );
  ...
  XOR2_X1 SQ_instance_U333 ( .A(SQ_instance_n303), .B(SQ_instance_n302), .Z(
        SQ_instance_n310) );
  XNOR2_X1 SQ_instance_U332 ( .A(a1p1[1]), .B(r1p1[1]), .ZN(SQ_instance_n302)
         );
  ...
  NOR2_X1 SQ_instance_U329 ( .A1(SQ_instance_n507), .A2(SQ_instance_n304), 
        .ZN(SQ_instance_n361) );
  INV_X1 SQ_instance_U328 ( .A(a1p1[0]), .ZN(SQ_instance_n507) );
  ...
  XNOR2_X1 SQ_instance_U325 ( .A(SQ_instance_n300), .B(SQ_instance_n301), .ZN(
        SQ_instance_n304) );
  XOR2_X1 SQ_instance_U324 ( .A(a1p1[0]), .B(SQ_instance_n493), .Z(
        SQ_instance_n301) );
  ...
  AND2_X1 SQ_instance_U322 ( .A1(SQ_instance_n311), .A2(SQ_instance_n313), 
        .ZN(SQ_instance_n298) );
  XNOR2_X1 SQ_instance_U321 ( .A(a1p1[2]), .B(r1p1[2]), .ZN(SQ_instance_n313)
         );
  ...
  NAND2_X1 SQ_instance_U319 ( .A1(SQ_instance_n303), .A2(SQ_instance_n295), 
        .ZN(SQ_instance_n296) );
  NAND2_X1 SQ_instance_U318 ( .A1(SQ_instance_n489), .A2(a1p1[1]), .ZN(
        SQ_instance_n295) );
  INV_X1 SQ_instance_U317 ( .A(r1p1[1]), .ZN(SQ_instance_n489) );
  NAND2_X1 SQ_instance_U316 ( .A1(a1p1[0]), .A2(SQ_instance_n493), .ZN(
        SQ_instance_n303) );
  INV_X1 SQ_instance_U315 ( .A(r1p1[0]), .ZN(SQ_instance_n493) );
  NAND2_X1 SQ_instance_U314 ( .A1(r1p1[1]), .A2(SQ_instance_n513), .ZN(
        SQ_instance_n297) );
  INV_X1 SQ_instance_U313 ( .A(a1p1[1]), .ZN(SQ_instance_n513) );
  NOR2_X1 SQ_instance_U312 ( .A1(r1p1[2]), .A2(SQ_instance_n506), .ZN(
        SQ_instance_n299) );
  INV_X1 SQ_instance_U311 ( .A(a1p1[2]), .ZN(SQ_instance_n506) );
  ...
  NOR2_X1 SQ_instance_U285 ( .A1(SQ_instance_n275), .A2(SQ_instance_n274), 
        .ZN(SQ_instance_n261) );
  NAND2_X1 SQ_instance_U284 ( .A1(SQ_instance_n260), .A2(a2p1[2]), .ZN(
        SQ_instance_n274) );
  INV_X1 SQ_instance_U283 ( .A(a2p1[2]), .ZN(SQ_instance_n487) );
  ...
  AND2_X1 SQ_instance_U263 ( .A1(SQ_instance_n245), .A2(SQ_instance_n248), 
        .ZN(SQ_instance_n235) );
  NAND2_X1 SQ_instance_U262 ( .A1(a2p1[2]), .A2(SQ_instance_n234), .ZN(
        SQ_instance_n248) );
  OR2_X1 SQ_instance_U261 ( .A1(SQ_instance_r5_rr[2]), .A2(SQ_instance_n233), 
        .ZN(SQ_instance_n245) );
  NAND2_X1 SQ_instance_U260 ( .A1(a2p1[1]), .A2(SQ_instance_n259), .ZN(
        SQ_instance_n246) );
  ...
  NOR2_X1 SQ_instance_U254 ( .A1(SQ_instance_r5_rr[1]), .A2(SQ_instance_n230), 
        .ZN(SQ_instance_n250) );
  NAND2_X1 SQ_instance_U253 ( .A1(a2p1[0]), .A2(SQ_instance_n259), .ZN(
        SQ_instance_n252) );
  ...
  OR2_X1 SQ_instance_U243 ( .A1(SQ_instance_n273), .A2(SQ_instance_n271), .ZN(
        SQ_instance_n223) );
  NAND2_X1 SQ_instance_U242 ( .A1(a2p1[0]), .A2(SQ_instance_n234), .ZN(
        SQ_instance_n271) );
  ...
  XNOR2_X1 SQ_instance_U240 ( .A(SQ_instance_n219), .B(SQ_instance_n218), .ZN(
        SQ_instance_n225) );
  XNOR2_X1 SQ_instance_U239 ( .A(a2p1[1]), .B(r2p1[1]), .ZN(SQ_instance_n218)
         );
  ...
  XOR2_X1 SQ_instance_U233 ( .A(SQ_instance_n216), .B(SQ_instance_n217), .Z(
        SQ_instance_n220) );
  XNOR2_X1 SQ_instance_U232 ( .A(a2p1[0]), .B(r2p1[0]), .ZN(SQ_instance_n217)
         );
  ...
  NOR2_X1 SQ_instance_U229 ( .A1(SQ_instance_n213), .A2(SQ_instance_n212), 
        .ZN(SQ_instance_n226) );
  NOR2_X1 SQ_instance_U228 ( .A1(a2p1[1]), .A2(SQ_instance_n471), .ZN(
        SQ_instance_n212) );
  NOR2_X1 SQ_instance_U227 ( .A1(SQ_instance_n219), .A2(SQ_instance_n211), 
        .ZN(SQ_instance_n213) );
  AND2_X1 SQ_instance_U226 ( .A1(SQ_instance_n471), .A2(a2p1[1]), .ZN(
        SQ_instance_n211) );
  INV_X1 SQ_instance_U225 ( .A(r2p1[1]), .ZN(SQ_instance_n471) );
  NOR2_X1 SQ_instance_U224 ( .A1(r2p1[0]), .A2(SQ_instance_n488), .ZN(
        SQ_instance_n219) );
  INV_X1 SQ_instance_U223 ( .A(a2p1[0]), .ZN(SQ_instance_n488) );
  XNOR2_X1 SQ_instance_U222 ( .A(a2p1[2]), .B(r2p1[2]), .ZN(SQ_instance_n228)
         );
  NAND2_X1 SQ_instance_U221 ( .A1(a2p1[2]), .A2(SQ_instance_n469), .ZN(
        SQ_instance_n215) );
  INV_X1 SQ_instance_U220 ( .A(r2p1[2]), .ZN(SQ_instance_n469) );
