...
architecture Behavioral of small_pSquare_3SHARES is
    ...
    signal plaintext_reg_0, plaintext_reg_1, plaintext_reg_2, round_tweak1, round_tweak2, key_reg1_0, key_reg1_1, key_reg1_2, key_reg2_0, key_reg2_1, key_reg2_2, round_tweakey_input_1, round_tweakey_input_2, art_output_0, art_output_1, art_output_2, round_reg_0, round_reg_1, round_reg_2, round_reg2_0, round_reg2_1, round_reg2_2 : small_pSquare_state;
    ...
    signal rst_reg, tweakey_active, reg_enable, f_select, f_select_reg : STD_LOGIC;
...
begin
    ...
    RoundInput: for i in 0 to 15 generate
        round_input_0(i) <= ("00" & plaintext_reg_0(i)) when (rst_reg = '1') else round_output_0(i);
        round_input_1(i) <= ("00" & plaintext_reg_1(i)) when (rst_reg = '1') else round_output_1(i);
        round_input_2(i) <= ("00" & plaintext_reg_2(i)) when (rst_reg = '1') else round_output_2(i);
    end generate;
