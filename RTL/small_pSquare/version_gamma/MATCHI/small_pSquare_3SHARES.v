module mulsubmodmersenne_7
  ...
  assign abc = n3115_o; // (signal)
  /* MulSubModMersenne.vhd:16:12  */
  assign abc_r = n3122_o; // (signal)
  /* MulSubModMersenne.vhd:20:14  */
  assign n3110_o = {7'b0, a};  //  uext
  /* MulSubModMersenne.vhd:20:14  */
  assign n3111_o = {7'b0, b};  //  uext
  /* MulSubModMersenne.vhd:20:14  */
  assign n3112_o = n3110_o * n3111_o; // umul
  /* MulSubModMersenne.vhd:20:21  */
  assign n3113_o = ~c;
  /* MulSubModMersenne.vhd:20:18  */
  assign n3114_o = {7'b0, n3113_o};  //  uext
  /* MulSubModMersenne.vhd:20:18  */
  assign n3115_o = n3112_o + n3114_o;
  /* MulSubModMersenne.vhd:21:24  */
  assign n3116_o = abc[6:0];
  /* MulSubModMersenne.vhd:21:19  */
  assign n3118_o = {1'b0, n3116_o};
  /* MulSubModMersenne.vhd:21:55  */
  assign n3119_o = abc[13:7];
  /* MulSubModMersenne.vhd:21:50  */
  assign n3121_o = {1'b0, n3119_o};
  /* MulSubModMersenne.vhd:21:43  */
  assign n3122_o = n3118_o + n3121_o;
  /* MulSubModMersenne.vhd:22:15  */
  assign n3123_o = abc_r[6:0];
  /* MulSubModMersenne.vhd:22:68  */
  assign n3124_o = abc_r[7];
  /* MulSubModMersenne.vhd:22:61  */
  assign n3126_o = {6'b000000, n3124_o};
  /* MulSubModMersenne.vhd:22:33  */
...
module muladdmodmersenne_7
  ...
  assign abc = n3096_o; // (signal)
  /* MulAddModMersenne.vhd:16:12  */
  assign abc_r = n3103_o; // (signal)
  /* MulAddModMersenne.vhd:20:14  */
  assign n3092_o = {7'b0, a};  //  uext
  /* MulAddModMersenne.vhd:20:14  */
  assign n3093_o = {7'b0, b};  //  uext
  /* MulAddModMersenne.vhd:20:14  */
  assign n3094_o = n3092_o * n3093_o; // umul
  /* MulAddModMersenne.vhd:20:18  */
  assign n3095_o = {7'b0, c};  //  uext
  /* MulAddModMersenne.vhd:20:18  */
  assign n3096_o = n3094_o + n3095_o;
  /* MulAddModMersenne.vhd:21:24  */
  assign n3097_o = abc[6:0];
  /* MulAddModMersenne.vhd:21:19  */
  assign n3099_o = {1'b0, n3097_o};
  /* MulAddModMersenne.vhd:21:55  */
  assign n3100_o = abc[13:7];
  /* MulAddModMersenne.vhd:21:50  */
  assign n3102_o = {1'b0, n3100_o};
  /* MulAddModMersenne.vhd:21:43  */
  assign n3103_o = n3099_o + n3102_o;
  /* MulAddModMersenne.vhd:22:15  */
  assign n3104_o = abc_r[6:0];
  /* MulAddModMersenne.vhd:22:68  */
  assign n3105_o = abc_r[7];
  /* MulAddModMersenne.vhd:22:61  */
  assign n3107_o = {6'b000000, n3105_o};
  /* MulAddModMersenne.vhd:22:33  */
  assign n3108_o = n3104_o + n3107_o;
endmodule
