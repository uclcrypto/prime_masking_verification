...
architecture Behavioral of small_pSquare_2SHARES is
    ...
    signal plaintext_reg_0, plaintext_reg_1, round_tweak1, round_tweak2, key_reg1_0, key_reg1_1, key_reg2_0, key_reg2_1, round_tweakey_inpt_1, art_outpt_0, art_outpt_1, round_reg_0, round_reg_1, round_reg2_0, round_reg2_1 : small_pSquare_state;
    signal art_ou_0, art_ou_1, round_tweakey, round_tweakey_inpt_0 : small_pSquare_state_p1;
    signal round_inpt_0, round_inpt_1, round_outpt_0, round_outpt_1 : small_pSquare_state_p2;
...
begin
    ...
    SQ1: SQ_2SHARE Generic Map (7) Port Map (clk, f1_in_0, f1_in_1, fresh_randomness(0), fresh_randomness(1), sq1_out_0, sq1_out_1);
    SQ2: SQ_2SHARE Generic Map (7) Port Map (clk, f2_in_0, f2_in_1, fresh_randomness(2), fresh_randomness(3), sq2_out_0, sq2_out_1);
    SQ3: SQ_2SHARE Generic Map (7) Port Map (clk, f3_in_0, f3_in_1, fresh_randomness(4), fresh_randomness(5), sq3_out_0, sq3_out_1);
    ...
    SQ4: SQ_2SHARE Generic Map (7) Port Map (clk, mds1_out_0, mds1_out_1, fresh_randomness(6), fresh_randomness(7), sq4_out_0, sq4_out_1);
    SQ5: SQ_2SHARE Generic Map (7) Port Map (clk, mds2_out_0, mds2_out_1, fresh_randomness(8), fresh_randomness(9), sq5_out_0, sq5_out_1);
    SQ6: SQ_2SHARE Generic Map (7) Port Map (clk, mds3_out_0, mds3_out_1, fresh_randomness(10), fresh_randomness(11), sq6_out_0, sq6_out_1);
