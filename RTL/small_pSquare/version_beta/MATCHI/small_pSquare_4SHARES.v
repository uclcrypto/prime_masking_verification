module muladdmodmersenne_7
  ...
  assign abc = n3919_o; // (signal)
  /* MulAddModMersenne.vhd:16:12  */
  assign abc_r = n3926_o; // (signal)
  /* MulAddModMersenne.vhd:17:12  */
  assign d_p = n3931_o; // (signal)
  /* MulAddModMersenne.vhd:21:14  */
  assign n3915_o = {7'b0, a};  //  uext
  /* MulAddModMersenne.vhd:21:14  */
  assign n3916_o = {7'b0, b};  //  uext
  /* MulAddModMersenne.vhd:21:14  */
  assign n3917_o = n3915_o * n3916_o; // umul
  /* MulAddModMersenne.vhd:21:18  */
  assign n3918_o = {7'b0, c};  //  uext
  /* MulAddModMersenne.vhd:21:18  */
  assign n3919_o = n3917_o + n3918_o;
  /* MulAddModMersenne.vhd:22:24  */
  assign n3920_o = abc[6:0];
  /* MulAddModMersenne.vhd:22:19  */
  assign n3922_o = {1'b0, n3920_o};
  /* MulAddModMersenne.vhd:22:55  */
  assign n3923_o = abc[13:7];
  /* MulAddModMersenne.vhd:22:50  */
  assign n3925_o = {1'b0, n3923_o};
  /* MulAddModMersenne.vhd:22:43  */
  assign n3926_o = n3922_o + n3925_o;
  /* MulAddModMersenne.vhd:23:17  */
  assign n3927_o = abc_r[6:0];
  /* MulAddModMersenne.vhd:23:70  */
  assign n3928_o = abc_r[7];
  /* MulAddModMersenne.vhd:23:63  */
  assign n3930_o = {6'b000000, n3928_o};
  /* MulAddModMersenne.vhd:23:35  */
  assign n3931_o = n3927_o + n3930_o;
  /* MulAddModMersenne.vhd:24:36  */
  assign n3934_o = d_p == 7'b1111111;
  /* MulAddModMersenne.vhd:24:26  */
  assign n3935_o = n3934_o ? 7'b0000000 : d_p;
endmodule
...
module mulsubsubmodmersenne_7
  ...
  assign abcd = n3897_o; // (signal)
  /* MulSubSubModMersenne.vhd:17:12  */
  assign abcd_r = n3904_o; // (signal)
  /* MulSubSubModMersenne.vhd:18:12  */
  assign e_p = n3909_o; // (signal)
  /* MulSubSubModMersenne.vhd:23:15  */
  assign n3887_o = {7'b0, a};  //  uext
  /* MulSubSubModMersenne.vhd:23:15  */
  assign n3888_o = {7'b0, b};  //  uext
  /* MulSubSubModMersenne.vhd:23:15  */
  assign n3889_o = n3887_o * n3888_o; // umul
  /* MulSubSubModMersenne.vhd:23:24  */
  assign n3891_o = 7'b1111111 - c;
  /* MulSubSubModMersenne.vhd:23:19  */
  assign n3892_o = {7'b0, n3891_o};  //  uext
  /* MulSubSubModMersenne.vhd:23:19  */
  assign n3893_o = n3889_o + n3892_o;
  /* MulSubSubModMersenne.vhd:23:34  */
  assign n3895_o = 7'b1111111 - d;
  /* MulSubSubModMersenne.vhd:23:29  */
  assign n3896_o = {7'b0, n3895_o};  //  uext
  /* MulSubSubModMersenne.vhd:23:29  */
  assign n3897_o = n3893_o + n3896_o;
  /* MulSubSubModMersenne.vhd:24:26  */
  assign n3898_o = abcd[6:0];
  /* MulSubSubModMersenne.vhd:24:20  */
  assign n3900_o = {1'b0, n3898_o};
  /* MulSubSubModMersenne.vhd:24:58  */
  assign n3901_o = abcd[13:7];
  /* MulSubSubModMersenne.vhd:24:52  */
  assign n3903_o = {1'b0, n3901_o};
  /* MulSubSubModMersenne.vhd:24:45  */
  assign n3904_o = n3900_o + n3903_o;
  /* MulSubSubModMersenne.vhd:25:18  */
  assign n3905_o = abcd_r[6:0];
  /* MulSubSubModMersenne.vhd:25:72  */
  assign n3906_o = abcd_r[7];
  /* MulSubSubModMersenne.vhd:25:64  */
  assign n3908_o = {6'b000000, n3906_o};
  /* MulSubSubModMersenne.vhd:25:36  */
  assign n3909_o = n3905_o + n3908_o;
  /* MulSubSubModMersenne.vhd:26:36  */
  assign n3912_o = e_p == 7'b1111111;
  /* MulSubSubModMersenne.vhd:26:26  */
  assign n3913_o = n3912_o ? 7'b0000000 : e_p;
endmodule
...
module mulsubaddmodmersenne_7
  ...
  assign abcd = n3869_o; // (signal)
  /* MulSubAddModMersenne.vhd:17:12  */
  assign abcd_r = n3876_o; // (signal)
  /* MulSubAddModMersenne.vhd:18:12  */
  assign e_p = n3881_o; // (signal)
  /* MulSubAddModMersenne.vhd:23:15  */
  assign n3861_o = {7'b0, a};  //  uext
  /* MulSubAddModMersenne.vhd:23:15  */
  assign n3862_o = {7'b0, b};  //  uext
  /* MulSubAddModMersenne.vhd:23:15  */
  assign n3863_o = n3861_o * n3862_o; // umul
  /* MulSubAddModMersenne.vhd:23:24  */
  assign n3865_o = 7'b1111111 - c;
  /* MulSubAddModMersenne.vhd:23:19  */
  assign n3866_o = {7'b0, n3865_o};  //  uext
  /* MulSubAddModMersenne.vhd:23:19  */
  assign n3867_o = n3863_o + n3866_o;
  /* MulSubAddModMersenne.vhd:23:29  */
  assign n3868_o = {7'b0, d};  //  uext
  /* MulSubAddModMersenne.vhd:23:29  */
  assign n3869_o = n3867_o + n3868_o;
  /* MulSubAddModMersenne.vhd:24:26  */
  assign n3870_o = abcd[6:0];
  /* MulSubAddModMersenne.vhd:24:20  */
  assign n3872_o = {1'b0, n3870_o};
  /* MulSubAddModMersenne.vhd:24:58  */
  assign n3873_o = abcd[13:7];
  /* MulSubAddModMersenne.vhd:24:52  */
  assign n3875_o = {1'b0, n3873_o};
  /* MulSubAddModMersenne.vhd:24:45  */
  assign n3876_o = n3872_o + n3875_o;
  /* MulSubAddModMersenne.vhd:25:18  */
  assign n3877_o = abcd_r[6:0];
  /* MulSubAddModMersenne.vhd:25:72  */
  assign n3878_o = abcd_r[7];
  /* MulSubAddModMersenne.vhd:25:64  */
  assign n3880_o = {6'b000000, n3878_o};
  /* MulSubAddModMersenne.vhd:25:36  */
  assign n3881_o = n3877_o + n3880_o;
  /* MulSubAddModMersenne.vhd:26:36  */
  assign n3884_o = e_p == 7'b1111111;
  /* MulSubAddModMersenne.vhd:26:26  */
  assign n3885_o = n3884_o ? 7'b0000000 : e_p;
endmodule
...
module muladdaddmodmersenne_7
  ...
  assign abcd = n3843_o; // (signal)
  /* MulAddAddModMersenne.vhd:17:12  */
  assign abcd_r = n3850_o; // (signal)
  /* MulAddAddModMersenne.vhd:18:12  */
  assign e_p = n3855_o; // (signal)
  /* MulAddAddModMersenne.vhd:22:15  */
  assign n3837_o = {7'b0, a};  //  uext
  /* MulAddAddModMersenne.vhd:22:15  */
  assign n3838_o = {7'b0, b};  //  uext
  /* MulAddAddModMersenne.vhd:22:15  */
  assign n3839_o = n3837_o * n3838_o; // umul
  /* MulAddAddModMersenne.vhd:22:19  */
  assign n3840_o = {7'b0, c};  //  uext
  /* MulAddAddModMersenne.vhd:22:19  */
  assign n3841_o = n3839_o + n3840_o;
  /* MulAddAddModMersenne.vhd:22:23  */
  assign n3842_o = {7'b0, d};  //  uext
  /* MulAddAddModMersenne.vhd:22:23  */
  assign n3843_o = n3841_o + n3842_o;
  /* MulAddAddModMersenne.vhd:23:26  */
  assign n3844_o = abcd[6:0];
  /* MulAddAddModMersenne.vhd:23:20  */
  assign n3846_o = {1'b0, n3844_o};
  /* MulAddAddModMersenne.vhd:23:58  */
  assign n3847_o = abcd[13:7];
  /* MulAddAddModMersenne.vhd:23:52  */
  assign n3849_o = {1'b0, n3847_o};
  /* MulAddAddModMersenne.vhd:23:45  */
  assign n3850_o = n3846_o + n3849_o;
  /* MulAddAddModMersenne.vhd:24:18  */
  assign n3851_o = abcd_r[6:0];
  /* MulAddAddModMersenne.vhd:24:72  */
  assign n3852_o = abcd_r[7];
  /* MulAddAddModMersenne.vhd:24:64  */
  assign n3854_o = {6'b000000, n3852_o};
  /* MulAddAddModMersenne.vhd:24:36  */
  assign n3855_o = n3851_o + n3854_o;
  /* MulAddAddModMersenne.vhd:25:36  */
  assign n3858_o = e_p == 7'b1111111;
  /* MulAddAddModMersenne.vhd:25:26  */
  assign n3859_o = n3858_o ? 7'b0000000 : e_p;
endmodule
...
module submodmersenne_7
  ...
  assign ab = n3826_o; // (signal)
  /* SubModMersenne.vhd:15:12  */
  assign c_p = n3831_o; // (signal)
  /* SubModMersenne.vhd:19:16  */
  assign n3823_o = {1'b0, a};
  /* SubModMersenne.vhd:19:28  */
  assign n3825_o = {1'b0, b};
  /* SubModMersenne.vhd:19:21  */
  assign n3826_o = n3823_o - n3825_o;
  /* SubModMersenne.vhd:20:14  */
  assign n3827_o = ab[6:0];
  /* SubModMersenne.vhd:20:64  */
  assign n3828_o = ab[7];
  /* SubModMersenne.vhd:20:60  */
  assign n3830_o = {6'b000000, n3828_o};
  /* SubModMersenne.vhd:20:32  */
  assign n3831_o = n3827_o - n3830_o;
  /* SubModMersenne.vhd:21:36  */
  assign n3834_o = c_p == 7'b1111111;
  /* SubModMersenne.vhd:21:26  */
  assign n3835_o = n3834_o ? 7'b0000000 : c_p;
endmodule
...
module addmodmersenne_7
  ...
  assign n3819_o = c_p == 7'b1111111;
  /* AddModMersenne.vhd:21:26  */
  assign n3820_o = n3819_o ? 7'b0000000 : c_p;
endmodule
