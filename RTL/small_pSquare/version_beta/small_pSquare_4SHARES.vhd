...
architecture Behavioral of small_pSquare_4SHARES is
    ...
    signal plaintext_reg_0, plaintext_reg_1, plaintext_reg_2, plaintext_reg_3, round_tweak1, round_tweak2, key_reg1_0, key_reg1_1, key_reg1_2, key_reg1_3, key_reg2_0, key_reg2_1, key_reg2_2, key_reg2_3, round_tweakey_inpt_1, round_tweakey_inpt_2, round_tweakey_inpt_3, art_outpt_0, art_outpt_1, art_outpt_2, art_outpt_3, round_reg_0, round_reg_1, round_reg_2, round_reg_3, round_reg2_0, round_reg2_1, round_reg2_2, round_reg2_3 : small_pSquare_state;
    signal art_ou_0, art_ou_1, art_ou_2, art_ou_3, round_tweakey, round_tweakey_inpt_0 : small_pSquare_state_p1;
    signal round_inpt_0, round_inpt_1,round_inpt_2, round_inpt_3, round_outpt_0, round_outpt_1, round_outpt_2, round_outpt_3 : small_pSquare_state_p2;
    ...
    signal rst_reg, tweakey_active, f_select, f_select_reg, doneflag : STD_LOGIC;
...
begin
    ...
    ARK: for i in 0 to 15 generate
        art_o_0(i) <= ('0' & round_inpt_0(i)) + ("00" & round_tweakey_inpt_0(i));
        art_o_1(i) <= ('0' & round_inpt_1(i)) + ("000" & round_tweakey_inpt_1(i));
        art_o_2(i) <= ('0' & round_inpt_2(i)) + ("000" & round_tweakey_inpt_2(i));
        art_o_3(i) <= ('0' & round_inpt_3(i)) + ("000" & round_tweakey_inpt_3(i));
        ...
        art_outpt_0(i) <= art_ou_0(i)(6 downto 0) + ("000000" & art_ou_0(i)(7));
        art_outpt_1(i) <= art_ou_1(i)(6 downto 0) + ("000000" & art_ou_1(i)(7));
        art_outpt_2(i) <= art_ou_2(i)(6 downto 0) + ("000000" & art_ou_2(i)(7));
        art_outpt_3(i) <= art_ou_3(i)(6 downto 0) + ("000000" & art_ou_3(i)(7));
        -- First Round-Constant Addition
        RC1_1: if i = 3 generate
            sq1_in_rr(0) <= ('0' & round_inpt_0(i)) + ("00" & round_tweakey_inpt_0(i)) + ("000" & round_constants1(0));
            sq1_in_r(0) <= ('0' & sq1_in_rr(0)(6 downto 0)) + ("00000" & sq1_in_rr(0)(9 downto 7));
            sq1_in(0) <= sq1_in_r(0)(6 downto 0) + ("000000" & sq1_in_r(0)(7));
        end generate;
        RC1_2: if i = 9 generate
            sq1_in_rr(1) <= ('0' & round_inpt_0(i)) + ("00" & round_tweakey_inpt_0(i)) + ("000" & round_constants1(1));
    ...
    -- F-Function
    FFC_1: FF Generic Map (7) Port Map (clk, round_constants2(0), round_constants2_reg(0));
    FFC_2: FF Generic Map (7) Port Map (clk, round_constants2(1), round_constants2_reg(1));
    FFC_3: FF Generic Map (7) Port Map (clk, sq1_in(0), sq1_in_reg(0));
    FFC_4: FF Generic Map (7) Port Map (clk, sq1_in(1), sq1_in_reg(1));
    
    f1_in_0 <= sq1_in(0) when (f_select = '0') else sq1_in(1);
    f1_in_1 <= art_outpt_1(3) when (f_select = '0') else art_outpt_1(9);
    f1_in_2 <= art_outpt_2(3) when (f_select = '0') else art_outpt_2(9);
    f1_in_3 <= art_outpt_3(3) when (f_select = '0') else art_outpt_3(9);
    f2_in_0 <= art_outpt_0(2) when (f_select = '0') else art_outpt_0(8);
    f2_in_1 <= art_outpt_1(2) when (f_select = '0') else art_outpt_1(8);
    f2_in_2 <= art_outpt_2(2) when (f_select = '0') else art_outpt_2(8);
    f2_in_3 <= art_outpt_3(2) when (f_select = '0') else art_outpt_3(8);
    f3_in_0 <= art_outpt_0(1) when (f_select = '0') else art_outpt_0(7);
    f3_in_1 <= art_outpt_1(1) when (f_select = '0') else art_outpt_1(7);
    f3_in_2 <= art_outpt_2(1) when (f_select = '0') else art_outpt_2(7);
    f3_in_3 <= art_outpt_3(1) when (f_select = '0') else art_outpt_3(7);
    ...
    SQ4: SQ_4SHARE Generic Map (7) Port Map (clk, mds1_out_0, mds1_out_1, mds1_out_2, mds1_out_3, fresh_randomness(36), fresh_randomness(37), fresh_randomness(38), fresh_randomness(39), fresh_randomness(40), fresh_randomness(41), fresh_randomness(42), fresh_randomness(43), fresh_randomness(44), fresh_randomness(45), fresh_randomness(46), fresh_randomness(47), sq4_out_0, sq4_out_1, sq4_out_2, sq4_out_3);
    SQ5: SQ_4SHARE Generic Map (7) Port Map (clk, mds2_out_0, mds2_out_1, mds2_out_2, mds2_out_3, fresh_randomness(48), fresh_randomness(49), fresh_randomness(50), fresh_randomness(51), fresh_randomness(52), fresh_randomness(53), fresh_randomness(54), fresh_randomness(55), fresh_randomness(56), fresh_randomness(57), fresh_randomness(58), fresh_randomness(59), sq5_out_0, sq5_out_1, sq5_out_2, sq5_out_3);
    SQ6: SQ_4SHARE Generic Map (7) Port Map (clk, mds3_out_0, mds3_out_1, mds3_out_2, mds3_out_3, fresh_randomness(60), fresh_randomness(61), fresh_randomness(62), fresh_randomness(63), fresh_randomness(64), fresh_randomness(65), fresh_randomness(66), fresh_randomness(67), fresh_randomness(68), fresh_randomness(69), fresh_randomness(70), fresh_randomness(71), sq6_out_0, sq6_out_1, sq6_out_2, sq6_out_3);
    FF1_0: FF Generic Map (7) Port Map (clk, mds1_out_0, mds1_out_reg_0);
    FF1_1: FF Generic Map (7) Port Map (clk, mds1_out_1, mds1_out_reg_1);
    FF1_2: FF Generic Map (7) Port Map (clk, mds1_out_2, mds1_out_reg_2);
    FF1_3: FF Generic Map (7) Port Map (clk, mds1_out_3, mds1_out_reg_3);
    FF2_0: FF Generic Map (7) Port Map (clk, mds2_out_0, mds2_out_reg_0);
    FF2_1: FF Generic Map (7) Port Map (clk, mds2_out_1, mds2_out_reg_1);
    FF2_2: FF Generic Map (7) Port Map (clk, mds2_out_2, mds2_out_reg_2);
    FF2_3: FF Generic Map (7) Port Map (clk, mds2_out_3, mds2_out_reg_3);
    FF3_0: FF Generic Map (7) Port Map (clk, mds3_out_0, mds3_out_reg_0);
    FF3_1: FF Generic Map (7) Port Map (clk, mds3_out_1, mds3_out_reg_1);
    FF3_2: FF Generic Map (7) Port Map (clk, mds3_out_2, mds3_out_reg_2);
    FF3_3: FF Generic Map (7) Port Map (clk, mds3_out_3, mds3_out_reg_3);
    FF4_0: FF Generic Map (7) Port Map (clk, mds4_out_0, mds4_out_reg_0);
    FF4_1: FF Generic Map (7) Port Map (clk, mds4_out_1, mds4_out_reg_1);
    FF4_2: FF Generic Map (7) Port Map (clk, mds4_out_2, mds4_out_reg_2);
    FF4_3: FF Generic Map (7) Port Map (clk, mds4_out_3, mds4_out_reg_3);
    ...
    round_outpt_0(0) <= ("00" & round_reg2_0(2));
    round_outpt_1(0) <= ("00" & round_reg2_1(2));
    round_outpt_2(0) <= ("00" & round_reg2_2(2));
    round_outpt_3(0) <= ("00" & round_reg2_3(2));
    round_outpt_0(1) <= ("00" & round_reg2_0(3));
    round_outpt_1(1) <= ("00" & round_reg2_1(3));
    round_outpt_2(1) <= ("00" & round_reg2_2(3));
    round_outpt_3(1) <= ("00" & round_reg2_3(3));
    round_outpt_0(2) <= f4_r4_out_add_0;
    round_outpt_1(2) <= f4_r4_out_add_1;
    round_outpt_2(2) <= f4_r4_out_add_2;
    round_outpt_3(2) <= f4_r4_out_add_3;
    round_outpt_0(3) <= f3_r5_out_add_0;
    round_outpt_1(3) <= f3_r5_out_add_1;
    round_outpt_2(3) <= f3_r5_out_add_2;
    round_outpt_3(3) <= f3_r5_out_add_3;
    round_outpt_0(4) <= f2_r6_out_add_0;
    round_outpt_1(4) <= f2_r6_out_add_1;
    round_outpt_2(4) <= f2_r6_out_add_2;
    round_outpt_3(4) <= f2_r6_out_add_3;
    round_outpt_0(5) <= f1_r7_out_add_0;
    round_outpt_1(5) <= f1_r7_out_add_1;
    round_outpt_2(5) <= f1_r7_out_add_2;
    round_outpt_3(5) <= f1_r7_out_add_3;
    round_outpt_0(6) <= ("00" & round_reg2_0(8));
    round_outpt_1(6) <= ("00" & round_reg2_1(8));
    round_outpt_2(6) <= ("00" & round_reg2_2(8));
    round_outpt_3(6) <= ("00" & round_reg2_3(8));
    round_outpt_0(7) <= ("00" & round_reg2_0(9));
    round_outpt_1(7) <= ("00" & round_reg2_1(9));
    round_outpt_2(7) <= ("00" & round_reg2_2(9));
    round_outpt_3(7) <= ("00" & round_reg2_3(9));
    round_outpt_0(8) <= f4_r10_out_add_0;
    round_outpt_1(8) <= f4_r10_out_add_1;
    round_outpt_2(8) <= f4_r10_out_add_2;
    round_outpt_3(8) <= f4_r10_out_add_3;
    round_outpt_0(9) <= f3_r11_out_add_0;
    round_outpt_1(9) <= f3_r11_out_add_1;
    round_outpt_2(9) <= f3_r11_out_add_2;
    round_outpt_3(9) <= f3_r11_out_add_3;
    round_outpt_0(10) <= f2_r12_out_add_0;
    round_outpt_1(10) <= f2_r12_out_add_1;
    round_outpt_2(10) <= f2_r12_out_add_2;
    round_outpt_3(10) <= f2_r12_out_add_3;
    round_outpt_0(11) <= f1_r13_out_add_0;
    round_outpt_1(11) <= f1_r13_out_add_1;
    round_outpt_2(11) <= f1_r13_out_add_2;
    round_outpt_3(11) <= f1_r13_out_add_3;
    round_outpt_0(12) <= ("00" & round_reg2_0(14));
    round_outpt_1(12) <= ("00" & round_reg2_1(14));
    round_outpt_2(12) <= ("00" & round_reg2_2(14));
    round_outpt_3(12) <= ("00" & round_reg2_3(14));
    round_outpt_0(13) <= ("00" & round_reg2_0(15));
    round_outpt_1(13) <= ("00" & round_reg2_1(15));
    round_outpt_2(13) <= ("00" & round_reg2_2(15));
    round_outpt_3(13) <= ("00" & round_reg2_3(15));
    round_outpt_0(14) <= ("00" & round_reg2_0(0));
    round_outpt_1(14) <= ("00" & round_reg2_1(0));
    round_outpt_2(14) <= ("00" & round_reg2_2(0));
    round_outpt_3(14) <= ("00" & round_reg2_3(0));
    round_outpt_0(15) <= ("00" & round_reg2_0(1));
    round_outpt_1(15) <= ("00" & round_reg2_1(1));
    round_outpt_2(15) <= ("00" & round_reg2_2(1));
    round_outpt_3(15) <= ("00" & round_reg2_3(1));
    
    -- Round Tweakey Addition only active every N_r Rounds
    round_tweakey_inpt_0 <= round_tweakey when tweakey_active = '1' else (others => (others => '0'));
    round_tweakey_inpt_1 <= key_reg1_1 when tweakey_active = '1' else (others => (others => '0'));
    round_tweakey_inpt_2 <= key_reg1_2 when tweakey_active = '1' else (others => (others => '0'));
    round_tweakey_inpt_3 <= key_reg1_3 when tweakey_active = '1' else (others => (others => '0'));
    
    -- Round Input Mux
    RoundInpt: for i in 0 to 15 generate
        round_inpt_0(i) <= (others => '0') when (doneflag = '1') else ("00" & plaintext_reg_0(i)) when (rst_reg = '1') else round_outpt_0(i);
        round_inpt_1(i) <= (others => '0') when (doneflag = '1') else ("00" & plaintext_reg_1(i)) when (rst_reg = '1') else round_outpt_1(i);
        round_inpt_2(i) <= (others => '0') when (doneflag = '1') else ("00" & plaintext_reg_2(i)) when (rst_reg = '1') else round_outpt_2(i);
        round_inpt_3(i) <= (others => '0') when (doneflag = '1') else ("00" & plaintext_reg_3(i)) when (rst_reg = '1') else round_outpt_3(i);
    end generate;
    ...
    FSM: process(clk)
        ...
        variable roundcounter : integer range 0 to 16;
    begin
        if rising_edge(clk) then
            if (rst = '1') then
                if (read_inpt = '1') then
                    plaintext_reg_0             <= plaintext_s0;
                    plaintext_reg_1             <= plaintext_s1;
                    plaintext_reg_2             <= plaintext_s2;
                    plaintext_reg_3             <= plaintext_s3;
                    key_reg1_0                  <= key_s0;
                    key_reg1_1                  <= key_s1;
                    key_reg1_2                  <= key_s2;
                    key_reg1_3                  <= key_s3;
                    ...
                    plaintext_reg_0             <= (others => (others => '0'));
                    plaintext_reg_1             <= (others => (others => '0'));
                    plaintext_reg_2             <= (others => (others => '0'));
                    plaintext_reg_3             <= (others => (others => '0'));
                    key_reg1_0                  <= (others => (others => '0'));
                    key_reg1_1                  <= (others => (others => '0'));
                    key_reg1_2                  <= (others => (others => '0'));
                    key_reg1_3                  <= (others => (others => '0'));
                    round_tweak1                <= (others => (others => '0'));
                end if;
                round_reg_0                     <= (others => (others => '0'));
                round_reg_1                     <= (others => (others => '0'));
                round_reg_2                     <= (others => (others => '0'));
                round_reg_3                     <= (others => (others => '0'));
                round_reg2_0                    <= (others => (others => '0'));
                round_reg2_1                    <= (others => (others => '0'));
                round_reg2_2                    <= (others => (others => '0'));
                round_reg2_3                    <= (others => (others => '0'));
                key_reg2_0                      <= (others => (others => '0'));
                key_reg2_1                      <= (others => (others => '0'));
                key_reg2_2                      <= (others => (others => '0'));
                key_reg2_3                      <= (others => (others => '0'));
                round_tweak2                    <= (others => (others => '0'));
                ciphertext_s0                   <= (others => (others => '0'));
                ciphertext_s1                   <= (others => (others => '0'));
                ciphertext_s2                   <= (others => (others => '0'));
                ciphertext_s3                   <= (others => (others => '0'));
                rot_pi                          <= pi;
                stepcounter                     := 0;
                roundcounter                    := 0;
                done                            <= '0';
                ...
                if (doneflag = '0') then
                    ...
                    plaintext_reg_2             <= (others => (others => '0'));
                    plaintext_reg_3             <= (others => (others => '0'));
                    round_reg_0                 <= art_outpt_0;
                    round_reg_1                 <= art_outpt_1;
                    round_reg_2                 <= art_outpt_2;
                    round_reg_3                 <= art_outpt_3;
                    ...
                    if (stepcounter = 0) then
                        ...
                        if (roundcounter = 16) then
                            done                <= '1';
                            doneflag            <= '1';
                            ciphertext_s0       <= art_outpt_0;
                            ciphertext_s1       <= art_outpt_1;
                            ciphertext_s2       <= art_outpt_2;
                            ciphertext_s3       <= art_outpt_3;
                        end if;
