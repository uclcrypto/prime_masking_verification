...
architecture Behavioral of SQ_2SHARE_PROLEADWRAP is
    ...
    signal a0p1, a1p1, r0p1, r1p1, b0p1, b1p1 : UNSIGNED (bits-1 downto 0);
...
begin
    ...
    Add3 : AddModMersenne Generic Map (bits) Port Map (r0, one, r0p1);
    Add4 : AddModMersenne Generic Map (bits) Port Map (r1, one, r1p1);
    Sub1 : SubModMersenne Generic Map (bits) Port Map (b0p1, one, b0);
    Sub2 : SubModMersenne Generic Map (bits) Port Map (b1p1, one, b1);

    SQ_instance: SQ_2SHARE Generic Map (bits) Port Map (clk, a0p1, a1p1, r0p1, r1p1, b0p1, b1p1);
