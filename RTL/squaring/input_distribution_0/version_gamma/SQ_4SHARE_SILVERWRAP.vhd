...
begin
    ...
    r0_p <= '1' when (r0 = p) else '0';
    r1_p <= '1' when (r1 = p) else '0';
    r2_p <= '1' when (r2 = p) else '0';
    r3_p <= '1' when (r3 = p) else '0';
    r4_p <= '1' when (r4 = p) else '0';
    r5_p <= '1' when (r5 = p) else '0';
    r6_p <= '1' when (r6 = p) else '0';
    r7_p <= '1' when (r7 = p) else '0';
    r8_p <= '1' when (r8 = p) else '0';
    r9_p <= '1' when (r9 = p) else '0';
    r10_p <= '1' when (r10 = p) else '0';
    r11_p <= '1' when (r11 = p) else '0';
    a0_sel_r <= zero when ((r0_p_r OR r1_p_r OR r2_p_r OR r3_p_r OR r4_p_r OR r5_p_r OR r6_p_r OR r7_p_r OR r8_p_r OR r9_p_r OR r10_p_r OR r11_p_r) = '1') else a0_mod_r;
    a1_sel_r <= zero when ((r0_p_r OR r1_p_r OR r2_p_r OR r3_p_r OR r4_p_r OR r5_p_r OR r6_p_r OR r7_p_r OR r8_p_r OR r9_p_r OR r10_p_r OR r11_p_r) = '1') else a1_mod_r;
    a2_sel_r <= zero when ((r0_p_r OR r1_p_r OR r2_p_r OR r3_p_r OR r4_p_r OR r5_p_r OR r6_p_r OR r7_p_r OR r8_p_r OR r9_p_r OR r10_p_r OR r11_p_r) = '1') else a2_mod_r;
    a3_sel_r <= zero when ((r0_p_r OR r1_p_r OR r2_p_r OR r3_p_r OR r4_p_r OR r5_p_r OR r6_p_r OR r7_p_r OR r8_p_r OR r9_p_r OR r10_p_r OR r11_p_r) = '1') else a3_mod_r;
