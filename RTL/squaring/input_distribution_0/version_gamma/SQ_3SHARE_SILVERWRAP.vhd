...
begin
    ...
    a0_sel_r <= zero when ((r0_p_r OR r1_p_r OR r2_p_r OR r3_p_r OR r4_p_r) = '1') else a0_mod_r;
    a1_sel_r <= zero when ((r0_p_r OR r1_p_r OR r2_p_r OR r3_p_r OR r4_p_r) = '1') else a1_mod_r;
    a2_sel_r <= zero when ((r0_p_r OR r1_p_r OR r2_p_r OR r3_p_r OR r4_p_r) = '1') else a2_mod_r;
