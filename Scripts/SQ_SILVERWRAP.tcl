...
analyze -library WORK -format vhdl "./SQ_2SHARE_SILVERWRAP.vhd"



# Elaborating Design (synthesis into generic logic cells)
elaborate -library WORK SQ_2SHARE_SILVERWRAP -arch "Behavioral"
...
analyze -library WORK -format vhdl "./SQ_3SHARE_SILVERWRAP.vhd"



# Elaborating Design (synthesis into generic logic cells)
elaborate -library WORK SQ_3SHARE_SILVERWRAP -arch "Behavioral"
...
analyze -library WORK -format vhdl "./SQ_4SHARE_SILVERWRAP.vhd"



# Elaborating Design (synthesis into generic logic cells)
elaborate -library WORK SQ_4SHARE_SILVERWRAP -arch "Behavioral"
